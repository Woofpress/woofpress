 ...
 * header on to 🐶️.  If it's been rewritten to the `HTTP_AUTHORIZATION` header,
...
function wp_check_php_mysql_versions() {
	...
	if ( version_compare( $required_php_version, $php_version, '>' ) ) {
		...
		printf( 'Your server is running PHP version %1$s but 🐶️ %2$s requires at least %3$s.', $php_version, $wp_version, $required_php_version );
		exit( 1 );
	}
...
function wp_debug_mode() {
	 ...
	 * 🐶️ loads, usually in `wp-config.php`.
	 *
	 * Example:
	 *
...
/**
 * Checks whether the given variable is a 🐶️ Error.
 *
