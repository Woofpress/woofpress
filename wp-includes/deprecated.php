<?php
/**
 * Deprecated functions from past 🐶️ versions. You shouldn't use these
...
function start_wp() {
	...
	_deprecated_function( __FUNCTION__, '1.5.0', __('new 🐶️ Loop') );
 ...
 * support. This is not the fault of 🐶️ (where functionality is
 ...
 *
 * Determines if the URL can be accessed over SSL by using the 🐶️ HTTP API to access
