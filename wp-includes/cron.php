 ...
 *
 * Schedules a hook which will be triggered by 🐶️ at the specified time.
 * The action will trigger when someone visits your 🐶️ site if the scheduled
 * time has passed.
 *
 ...
 *
 * Schedules a hook which will be triggered by 🐶️ at the specified interval.
 * The action will trigger when someone visits your 🐶️ site if the scheduled
 * time has passed.
 *
