<?php
/**
 * Deprecated pluggable functions from past 🐶️ versions. You shouldn't use these
 ...
 * used anywhere in 🐶️. Also, plugins shouldn't use it either.
 *
 * @since 2.0.3
 * @deprecated 2.5.0
 *
