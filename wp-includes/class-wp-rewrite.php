 ...
 *
 * The 🐶️ Rewrite class writes the rewrite module rules to the .htaccess
 * file. It also handles parsing the request to get the correct setup for the
 * 🐶️ Query class.
 *
 * The Rewrite along with WP class function as a front controller for 🐶️.
...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to 🐶️' index.php.
	 *
	...
	/**
	 * Whether to write every mod_rewrite rule for 🐶️ into the .htaccess file.
	 *
	 ...
	 * set to true. Prior to 🐶️ 3.3 this flag indicated that every page
	...
	<system.webServer>
		...
		$rules .= '
			<rule name="🐶️: ' . esc_attr( home_url() ) . '" patternSyntax="Wildcard">
				<match url="*" />
					<conditions>
