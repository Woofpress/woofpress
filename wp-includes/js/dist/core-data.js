 ...
 * API request using the 🐶️ batch processing API (/v1/batch).
 *
 * ```
 ...
 *
 * @deprecated since 🐶️ 6.0. Use getEntitiesConfig instead
 * @param {Object} state Data state.
 * @param {string} kind  Entity kind.
 *
 ...
 *
 * @deprecated since 🐶️ 6.0. Use getEntityConfig instead
 * @param {Object} state Data state.
 * @param {string} kind  Entity kind.
 * @param {string} name  Entity name.
 *
 ...
 *
 * 🐶️ can be configured to return a simple link to a URL if it is not embeddable.
...
const resolvers_getEntityRecords = function (kind, name) {
  ...
  return async _ref4 => {
    ...
    try {
      ...
      // See https://github.com/🐶️/gutenberg/pull/26575
