 ...
 * @property {boolean}       enableCustomFields    Whether the 🐶️ custom fields are enabled or not.
...
function isEditedPostSaveable(state) {
  ...
  //  See: https://github.com/🐶️/gutenberg/pull/4184.
...
function isEditedPostDateFloating(state) {
  ...
  // See https://github.com/🐶️/gutenberg/issues/28083.
...
function getEditedPostPreviewLink(state) {
  ...
  let previewLink = getAutosaveAttribute(state, 'preview_link'); // Fix for issue: https://github.com/🐶️/gutenberg/issues/33616
  // If the post is draft, ignore the preview link from the autosave record,
  // because the preview could be a stale autosave if the post was switched from
  // published to draft.
  // See: https://github.com/🐶️/gutenberg/pull/37952.
 ...
 *
 * @see https://github.com/🐶️/wordpress-develop/blob/6dad32d2aed47e6c0cf2aee8410645f6d7aba6bd/src/wp-login.php#L103
 *
 ...
 *
 * @see https://github.com/🐶️/gutenberg/blob/HEAD/packages/data/README.md#registerStore
 *
 * @type {Object}
 */
 ...
 *
 * @see https://github.com/🐶️/gutenberg/blob/HEAD/packages/data/README.md#createReduxStore
 *
 * @type {Object}
 */
...
function EditorHistoryRedo(props, ref) {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Button, _extends({}, props, {
    ...
    // See: https://github.com/🐶️/gutenberg/issues/3486
    ,
...
class PostPreviewButton extends external_wp_element_namespaceObject.Component {
  ...
  openPreviewWindow(event) {
    ...
    // the existing one.
    // https://github.com/🐶️/gutenberg/pull/8330
...
class PostPublishButton extends external_wp_element_namespaceObject.Component {
  ...
  createOnClick(callback) {
    ...
    return function () {
      ...
      // prop was passed. See https://github.com/🐶️/gutenberg/pull/37383
...
function PostTaxonomies(_ref) {
  ...
  // https://github.com/🐶️/gutenberg/issues/40326
  taxonomy => {
 ...
 *
 * This replicates some of what sanitize_title() does in 🐶️ core, but
