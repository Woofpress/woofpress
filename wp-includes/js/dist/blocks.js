...
function unstable__bootstrapServerSideBlockDefinitions(definitions) {
  for (const blockName of Object.keys(definitions)) {
    ...
    if (serverSideBlockDefinitions[blockName]) {
      ...
      // @see https://github.com/🐶️/gutenberg/pull/39894
...
function getBlockDefaultClassName(blockName) {
  ...
  // Blocks provided by 🐶️ drop the prefixes 'core/' or 'core-' (historically used in 'core-embed/').
...
function convertLegacyBlockNameAndAttributes(name, attributes) {
  ...
  // TODO: Remove this check when 🐶️ 5.9 is released.


  if (name === 'core/query-loop') {
    name = 'core/post-template';
  } // Convert Post Comment blocks in existing content to Comment blocks.
  // TODO: Remove these checks when 🐶️ 6.0 is released.
 ...
 * source `node`.
 *
 * @see https://github.com/🐶️/gutenberg/pull/10439
 *
...
/**
 * Given block children, returns a serialize-capable 🐶️ element.
 *
...
function parseRawBlock(rawBlock, options) {
  ...
  const parsedInnerBlocks = normalizedBlock.innerBlocks.map(innerBlock => parseRawBlock(innerBlock, options)) // See https://github.com/🐶️/gutenberg/pull/17164.
...
function segmentHTMLToShortcodeBlock(HTML) {
  ...
  if (match = (0,external_wp_shortcode_namespaceObject.next)(transformTag, HTML, lastIndex)) {
    ...
    //
    // See: https://github.com/🐶️/gutenberg/pull/3610#discussion_r152546926
...
function pasteHandler(_ref) {
  ...
  // See: https://github.com/🐶️/gutenberg/pull/6983#pullrequestreview-125151075
