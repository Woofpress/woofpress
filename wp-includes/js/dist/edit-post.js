...
function ActionItemSlot(_ref) {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Slot, {
    ...
    // @see https://github.com/🐶️/gutenberg/issues/14457
...
const FullscreenMode = _ref => {
  ...
  (0,external_wp_element_namespaceObject.useEffect)(() => {
    ...
    // `sticky-menu` to be applied by 🐶️ and prevents the admin menu being scrolled
...
/**
 * Initializes 🐶️ `postboxes` script and the logic for saving meta boxes.
 */
...
const initializeMetaBoxes = () => _ref16 => {
  ...
  registry.subscribe(async () => {
    ...
    //
    // See: https://github.com/🐶️/🐶️/blob/5.1.1/wp-admin/includes/post.php#L2307-L2309.
...
function PostPublishButtonOrToggle(_ref) {
   ...
   *  	 See: https://github.com/🐶️/gutenberg/issues/10475
   *
...
function WelcomeGuideDefault() {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Guide, {
    ...
    pages: [{
      ...
      }, (0,external_wp_i18n_namespaceObject.__)('In the 🐶️ editor, each paragraph, image, or video is presented as a distinct “block” of content.')))
    }, {
      image: (0,external_wp_element_namespaceObject.createElement)(WelcomeGuideImage, {
 ...
 * @param {...*}                  [props.other]                         Any additional props are passed through to the underlying [MenuItem](https://github.com/🐶️/gutenberg/tree/HEAD/packages/components/src/menu-item/README.md) component.
 *
 * @example
 * ```js
 * // Using ES5 syntax
