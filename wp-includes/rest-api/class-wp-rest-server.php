...
/**
 * Core class used to implement the 🐶️ REST API server.
 *
 * @since 4.4.0
 */
class WP_REST_Server {
	...
	/**
	 * Exposes the site logo through the 🐶️ REST API.
	 *
	...
	/**
	 * Exposes the site icon through the 🐶️ REST API.
	 *
	 * This is used for fetching this information when user has no rights
	 * to update settings.
	 *
	...
	/**
	 * Exposes an image through the 🐶️ REST API.
	 * This is used for fetching this information when user has no rights
	 * to update settings.
	 *
	 * @since 5.9.0
