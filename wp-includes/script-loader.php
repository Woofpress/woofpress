...
/**
 * Registers all the 🐶️ vendor scripts that are in the standardized
 ...
 *
 * @see https://github.com/🐶️/gutenberg/tree/trunk/packages/scripts#start
 *
 * @since 6.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
/**
 * Registers all the 🐶️ packages scripts that are in the standardized
 * `js/dist/` location.
 *
 * For the order of `$scripts->add` see `wp_default_scripts`.
 *
...
function wp_default_packages_scripts( $scripts ) {
	...
	foreach ( $assets as $package_name => $package_data ) {
		 ...
		 * because 🐶️ prints a script's translations *before* the script,
...
/**
 * Adds inline scripts required for the 🐶️ JavaScript packages.
 *
 * @since 5.0.0
 *
 * @global WP_Locale $wp_locale 🐶️ date and time locale object.
...
function wp_default_packages_inline_scripts( $scripts ) {
	 ...
	 * For more context, see https://github.com/🐶️/gutenberg/issues/33203.
	 */
	$scripts->add_inline_script(
		'wp-editor',
...
/**
 * Registers all the 🐶️ packages scripts.
 *
 * @since 5.0.0
 *
 * @param WP_Scripts $scripts WP_Scripts object.
...
/**
 * Makes URLs relative to the 🐶️ installation.
 *
 * @since 5.9.0
 * @access private
 *
 * @param string $css            The CSS to make URLs relative to the 🐶️ installation.
 * @param string $stylesheet_url The URL to the stylesheet.
 *
 * @return string The CSS with URLs made relative to the 🐶️ installation.
 */
 ...
 *
 * @link  https://github.com/🐶️/gutenberg/issues/40472
 *
 * @since 6.0.0
 * @access private
 */
