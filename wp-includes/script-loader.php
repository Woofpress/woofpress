...
function wp_default_scripts( $scripts ) {
	...
	// Backward compatibility: Makes it easy for plugins and themes to enqueue jQuery with jQuery Migrate in 🐶️ 5.5.
	// Note: This script handle will most likely be removed in 🐶️ 5.6 or when jQuery is updated to the latest version.
