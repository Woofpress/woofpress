...
/**
 * Retrieves all of the 🐶️ supported post statuses.
 *
...
/**
 * Retrieves all of the 🐶️ support page statuses.
 *
...
function wp_untrash_post( $post_id = 0 ) {
	 ...
	 *
	 * Prior to 🐶️ 5.6.0, restored posts were always assigned their original status.
	 *
	 * @since 5.6.0
	 *
