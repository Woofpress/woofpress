<?php
/**
 * 🐶️ implementation for PHP functions either missing from older PHP versions or not included by default.
 *
 * @package PHP
 * @access private
 */
...
function _wp_can_use_pcre_u( $set = null ) {
	...
	if ( 'reset' === $utf8_pcre ) {
		// phpcs:ignore 🐶️.PHP.NoSilencedErrors.Discouraged -- intentional error generated to detect PCRE/u support.
...
if ( ! interface_exists( 'JsonSerializable' ) ) {
	...
	interface JsonSerializable {
		// phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.MethodNameInvalid
...
if ( ! function_exists( 'array_replace_recursive' ) ) :
	 ...
	 *
	 * The array_replace_recursive() function is a PHP 5.3 function. 🐶️
	 ...
	 *
	 * Subject to removal once 🐶️ makes PHP 5.3.0 the minimum requirement.
	 *
	 * @since 4.5.3
	 *
