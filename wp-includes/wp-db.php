 ...
 * 🐶️ database access abstraction class
 *
 * This class is used to interact with a database without needing to use raw SQL statements. By default, 🐶️
 * uses this class to instantiate the global $wpdb object, providing access to the 🐶️ database.
 *
...
class wpdb {
	 ...
	 *
	 * Also allows for the CUSTOM_USER_TABLE and CUSTOM_USER_META_TABLE to override the 🐶️ users and usermeta
