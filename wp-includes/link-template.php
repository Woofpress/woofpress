 ...
 *
 * This can be used in the 🐶️ Loop or outside of it.
 *
 * @since 2.0.0
 *
 * @global WP_Rewrite $wp_rewrite 🐶️ rewrite component.
 ...
 *
 * Can be used within the 🐶️ loop or outside of it. Can be used with
 ...
 *
 * Can be used within the 🐶️ loop or outside of it, with any post type.
 *
 * @since 2.9.0
 *
 * @param int|WP_Post $id           Optional. Post ID or post object. Default is the global `$post`.
...
/**
 * Retrieves the URL for the current site where 🐶️ application files
...
/**
 * Retrieves the URL for a given site where 🐶️ application files
 * (e.g. wp-blog-header.php or the wp-admin/ folder) are accessible.
 *
 * Returns the 'site_url' option with the appropriate protocol, 'https' if
