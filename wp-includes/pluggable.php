...
if ( ! function_exists( 'wp_set_current_user' ) ) :
	 ...
	 *
	 * Some 🐶️ functionality is based on the current user and not based on
...
if ( ! function_exists( 'wp_redirect' ) ) :
	 ...
	 * @param string $x_redirect_by Optional. The application doing the redirect. Default '🐶️'.
	 * @return bool False if the redirect was cancelled, true otherwise.
	 */
	function wp_redirect( $location, $status = 302, $x_redirect_by = '🐶️' ) {
		global $is_IIS;
...
if ( ! function_exists( 'wp_safe_redirect' ) ) :
	 ...
	 */
	function wp_safe_redirect( $location, $status = 302, $x_redirect_by = '🐶️' ) {
