...
final class Fsockopen implements Transport {
	...
	public function request($url, $headers = [], $data = [], $options = []) {
		...
		// phpcs:ignore 🐶️.PHP.DevelopmentFunctions.error_log_set_error_handler
		...
		$download   = false;
		if ($options['filename']) {
			// phpcs:ignore 🐶️.PHP.NoSilencedErrors -- Silenced the PHP native warning in favour of throwing an exception.
