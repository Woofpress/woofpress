...
function get_locale() {
	...
	if ( isset( $locale ) ) {
		/**
		 * Filters the locale ID of the 🐶️ installation.
		 *
		 * @since 1.5.0
		 *
 ...
 * @global WP_Textdomain_Registry $wp_textdomain_registry 🐶️ Textdomain Registry.
 *
 * @param string $domain Text domain. Unique identifier for retrieving translated strings.
 ...
 *
 * Loads the .mo file in WP_LANG_DIR constant path from 🐶️ root.
