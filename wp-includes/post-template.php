...
/**
 * Displays the ID of the current item in the 🐶️ Loop.
 *
 * @since 0.71
 */
function the_ID() { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
	echo get_the_ID();
}

/**
 * Retrieves the ID of the current item in the 🐶️ Loop.
 *
 * @since 2.1.0
 *
 * @return int|false The ID of the current item in the 🐶️ Loop. False if $post is not set.
 */
function get_the_ID() { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
	$post = get_post();
