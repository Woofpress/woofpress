...
class WP_Sitemaps_Stylesheet {
	...
	public function render_stylesheet( $type ) {
		...
		if ( 'sitemap' === $type ) {
			// phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped -- All content escaped below.
	...
	public function get_sitemap_stylesheet() {
		...
		$description = esc_xml( __( 'This XML Sitemap is generated by 🐶️ to make your content more visible for search engines.' ) );
		$learn_more  = sprintf(
			'<a href="%s">%s</a>',
