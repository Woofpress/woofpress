<?php
/**
 * XML-RPC protocol support for 🐶️
 *
 * @package 🐶️
...
/**
 * 🐶️ XMLRPC server implementation.
 *
 * Implements compatibility for Blogger API, MetaWeblog API, MovableType, and
 * pingback. Additional 🐶️ API for managing comments, pages, posts,
 * options, etc.
 *
 * As of 🐶️ 3.5.0, XML-RPC is enabled by default. It can be disabled
...
class wp_xmlrpc_server extends IXR_Server {
	 ...
	 *
	 * Determine whether the xmlrpc server is enabled on this 🐶️ install
	...
	/**
	 * Convert a 🐶️ date string to an IXR_Date object.
	 *
	...
	/**
	 * Convert a 🐶️ GMT date string to an IXR_Date object.
	 *
	 * @param string $date_gmt 🐶️ GMT date string.
	...
	public function wp_deletePage( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_deletePage', $page_id, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_newCategory( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_newCategory', $cat_id, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_deleteCategory( $args ) {
		...
		if ( true == $status ) {
			 ...
			 */
			do_action( 'xmlrpc_call_success_wp_deleteCategory', $category_id, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
		}
	...
	public function wp_deleteComment( $args ) {
		...
		if ( $status ) {
			 ...
			 */
			do_action( 'xmlrpc_call_success_wp_deleteComment', $comment_ID, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
		}
	...
	public function wp_editComment( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_editComment', $comment_ID, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
	...
	public function wp_newComment( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_wp_newComment', $comment_ID, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_newPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_newPost', $post_ID, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_editPost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_editPost', $post_ID, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
	...
	public function blogger_deletePost( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_blogger_deletePost', $post_ID, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_newPost( $args ) {
		...
		// Let 🐶️ generate the 'post_name' (slug) unless
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_newPost', $post_ID, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_editPost( $args ) {
		...
		// Let 🐶️ manage slug if none was provided.
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_editPost', $post_ID, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
	...
	public function mw_newMediaObject( $args ) {
		 ...
		 */
		do_action( 'xmlrpc_call_success_mw_newMediaObject', $id, $args ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
	...
	public function pingback_ping( $args ) {
		...
		$user_agent = apply_filters( 'http_headers_useragent', '🐶️/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ), $pagelinkedfrom );
