...
/**
 * Require the template file with 🐶️ environment.
 *
 * The globals are set up for the template file to ensure that the 🐶️
...
function load_template( $_template_file, $require_once = true ) {
	...
	if ( is_array( $wp_query->query_vars ) ) {
		 ...
		 */
		// phpcs:ignore 🐶️.PHP.DontExtract.extract_extract
