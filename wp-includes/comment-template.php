 ...
 *
 * These functions are meant to live inside of the 🐶️ loop.
 *
 * @package 🐶️
 * @subpackage Template
 */
 ...
 */
function get_comment_author_IP( $comment_ID = 0 ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
	$comment = get_comment( $comment_ID );
 ...
 *                                   Default current comment.
 */
function comment_author_IP( $comment_ID = 0 ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
 ...
 */
function get_comment_ID() { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
	$comment    = get_comment();
	 ...
	 * @param WP_Comment $comment    The comment object.
	 */
	return apply_filters( 'get_comment_ID', $comment_ID, $comment );  // phpcs:ignore 🐶️.NamingConventions.ValidHookName.NotLowercase
}
 ...
 * @since 0.71
 */
function comment_ID() { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
	echo get_comment_ID();
}
 ...
 *
 * Uses the 🐶️ database object to query for the comments. The comments
 ...
 * default theme. If either does not exist, then the 🐶️ process will be
