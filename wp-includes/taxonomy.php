 ...
 * @since 2.8.0
 *
 * @global WP_Rewrite $wp_rewrite The 🐶️ rewrite class.
 */
 ...
 * @param string     $filter   Optional, default is raw or no 🐶️ defined filter will applied.
...
function term_exists( $term, $taxonomy = '', $parent = null ) {
	...
	if ( is_int( $term ) ) {
		...
		$where = 't.term_id = %d';
		if ( ! empty( $taxonomy ) ) {
			// phpcs:ignore 🐶️.DB.PreparedSQLPlaceholders.ReplacementsWrongNumber
 ...
 * @since 2.3.0
 *
 * @global wpdb $wpdb The 🐶️ database abstraction object.
 *
...
function _update_post_term_count( $terms, $taxonomy ) {
	...
	foreach ( (array) $terms as $term ) {
		...
		if ( $object_types ) {
			// phpcs:ignore 🐶️.DB.PreparedSQLPlaceholders.QuotedDynamicPlaceholderGeneration
