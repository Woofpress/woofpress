...
/**
 * Protects 🐶️ special option from being modified.
 *
 ...
 * @param string|bool $autoload Optional. Whether to load the option when 🐶️ starts up. For existing options,
 ...
 * @param string|bool $autoload   Optional. Whether to load the option when 🐶️ starts up.
...
/**
 * Removes option by name. Prevents removal of protected 🐶️ options.
 *
 * @since 1.2.0
 *
 * @global wpdb $wpdb 🐶️ database abstraction object.
...
/**
 * Registers default settings available in 🐶️.
 *
 * The settings registered here are primarily useful for the REST API, so this
 * does not encompass all settings available in 🐶️.
 *
 * @since 4.7.0
 */
