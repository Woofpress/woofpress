 ...
 *
 * These functions must be used within the 🐶️ Loop.
 *
 ...
 * @access private
 */
function __clear_multi_author_cache() { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore,PHPCompatibility.FunctionNameRestrictions.ReservedFunctionNames.FunctionDoubleUnderscore
