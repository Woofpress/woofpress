...
class WP {
	...
	/**
	 * Query variables for setting up the 🐶️ Query Loop.
	 *
	 * @since 2.0.0
	 * @var array
	 */
	...
	/**
	 * Parses the request to find the correct 🐶️ query.
	 *
	...
	public function parse_request( $extra_query_vars = '' ) {
		 ...
		 * @param WP           $this             Current 🐶️ environment instance.
		 ...
		 * @since 2.1.0
		 *
		 * @param WP $this Current 🐶️ environment instance (passed by reference).
		 */
	...
	public function send_headers() {
		 ...
		 * @param WP       $wp      Current 🐶️ environment instance.
		 */
	...
	public function handle_404() {
		 ...
		 * @param WP_Query $wp_query 🐶️ Query object.
		 */
	...
	/**
	 * Sets up all of the variables required by the 🐶️ environment.
	 *
	...
	public function main( $query_args = '' ) {
		...
		/**
		 * Fires once the 🐶️ environment has been set up.
		 *
		 * @since 2.1.0
		 *
		 * @param WP $this Current 🐶️ environment instance (passed by reference).
