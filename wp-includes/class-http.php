...
class WP_Http {
	 ...
	 *                                             Default '🐶️/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ).
	...
	public function request( $url, $args = array() ) {
		$defaults = array(
			 ...
			 * @since 5.1.0 The `$url` parameter was added.
			 *
			 * @param string $user_agent 🐶️ user agent string.
			 * @param string $url        The request URL.
			 */
			'user-agent'          => apply_filters( 'http_headers_useragent', '🐶️/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ), $url ),
			/**
	 ...
	 */
	public static function processResponse( $strResponse ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.MethodNameInvalid
		$res = explode( "\r\n\r\n", $strResponse, 2 );
	 ...
	 */
	public static function processHeaders( $headers, $url = '' ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.MethodNameInvalid
	 ...
	 */
	public static function buildCookieHeader( &$r ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.MethodNameInvalid
		if ( ! empty( $r['cookies'] ) ) {
	 ...
	 */
	public static function chunkTransferDecode( $body ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.MethodNameInvalid
