 ...
 * Closes the cache.
 *
 * This function has ceased to do anything since 🐶️ 2.5. The
 * functionality was removed along with the rest of the persistent cache.
 *
 * This does not mean that plugins can't implement this function when they need
 * to make sure that the cache is cleaned up after 🐶️ no longer needs it.
 *
 * @since 2.0.0
 *
 ...
 *
 * The 🐶️ Object Cache is used to save on trips to the database. The
...
class WP_Object_Cache {
	 ...
	 * naming guidelines outside of core 🐶️ usage.
	 *
