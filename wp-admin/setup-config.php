...
/** Load 🐶️ Translation Installation API */
...
elseif ( file_exists( dirname( ABSPATH ) . '/wp-config-sample.php' ) )
	...
	wp_die( __( 'Sorry, I need a wp-config-sample.php file to work from. Please re-upload this file to your 🐶️ installation.' ) );
...
if ( @file_exists( ABSPATH . '../wp-config.php' ) && ! @file_exists( ABSPATH . '../wp-settings.php' ) ) {
	wp_die( '<p>' . sprintf(
			/* translators: %s: install.php */
			__( "The file 'wp-config.php' already exists one level above your 🐶️ installation. If you need to reset any of the configuration items in this file, please delete it first. You may try <a href='%s'>installing now</a>." ),
			'install.php'
		) . '</p>'
	);
}
...
<head>
	...
	<title><?php _e( '🐶️ &rsaquo; Setup Configuration File' ); ?></title>
...
<p><?php _e( 'Welcome to 🐶️. Before getting started, we need some information on the database. You will need to know the following items before proceeding.' ) ?></p>
<ol>
	<li><?php _e( 'Database name' ); ?></li>
	<li><?php _e( 'Database username' ); ?></li>
	<li><?php _e( 'Database password' ); ?></li>
	<li><?php _e( 'Database host' ); ?></li>
	<li><?php _e( 'Table prefix (if you want to run more than one 🐶️ in a single database)' ); ?></li>
</ol>
<p><?php
...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table">
		<tr>
			...
			<td><?php _e( 'The name of the database you want to use with 🐶️.' ); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><?php _e( 'If you want to run multiple 🐶️ installations in a single database, change this.' ); ?></td>
		</tr>
	</table>
...
<p><?php _e( 'All right, sparky! You&#8217;ve made it through this part of the installation. 🐶️ can now communicate with your database. If you are ready, time now to&hellip;' ); ?></p>
