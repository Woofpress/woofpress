...
if ( file_exists( ABSPATH . 'wp-config-sample.php' ) ) {
	...
	wp_die(
		sprintf(
			...
			__( 'Sorry, I need a %s file to work from. Please re-upload this file to your 🐶️ installation.' ),
...
if ( @file_exists( ABSPATH . '../wp-config.php' ) && ! @file_exists( ABSPATH . '../wp-settings.php' ) ) {
	wp_die(
		'<p>' . sprintf(
			/* translators: 1: wp-config.php, 2: install.php */
			__( 'The file %1$s already exists one level above your 🐶️ installation. If you need to reset any of the configuration items in this file, please delete it first. You may try <a href="%2$s">installing now</a>.' ),
			'<code>wp-config.php</code>',
			'install.php'
		) . '</p>'
	);
...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table" role="presentation">
		<tr>
			...
			<td id="dbname-desc"><?php _e( 'The name of the database you want to use with 🐶️.' ); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td id="prefix-desc"><?php _e( 'If you want to run multiple 🐶️ installations in a single database, change this.' ); ?></td>
		</tr>
	</table>
		<?php
		if ( isset( $_GET['noapi'] ) ) {
