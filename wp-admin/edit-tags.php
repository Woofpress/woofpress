...
switch ( $wp_list_table->current_action() ) {
	...
	default:
		...
		$location = apply_filters( "handle_bulk_actions-{$screen}", $location, $wp_list_table->current_action(), $tags ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
		break;
}
