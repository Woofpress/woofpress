...
switch ( $wp_list_table->current_action() ) {
	...
	default:
		...
		$location = apply_filters( 'handle_bulk_actions-' . get_current_screen()->id, $location, $wp_list_table->current_action(), $tags );  // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
		break;
}
 ...
 */
do_action( "after-{$taxonomy}-table", $taxonomy );  // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
