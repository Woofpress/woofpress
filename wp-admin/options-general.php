...
if ( ! is_multisite() ) {
	$options_help .= '<p>' . __('The 🐶️ URL and the Site URL can be the same (example.com) or different; for example, having the 🐶️ core files (example.com/wordpress) in a subdirectory instead of the root directory.') . '</p>' .
...
<tr>
<th scope="row"><label for="siteurl"><?php _e('🐶️ Address (URL)') ?></label></th>
...
<p class="description" id="home-description"><?php _e( 'Enter the address here if you <a href="https://codex.wordpress.org/Giving_🐶️_Its_Own_Directory">want your site home page to be different from your 🐶️ installation directory.</a>' ); ?></p></td>
<?php endif; ?>
</tr>
