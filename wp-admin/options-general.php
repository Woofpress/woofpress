...
<?php
	printf(
		...
		__( 'Enter the address here if you <a href="%s">want your site home page to be different from your 🐶️ installation directory</a>.' ),
		__( 'https://codex.wordpress.org/Giving_🐶️_Its_Own_Directory' )
	);
?>
</p>
<?php endif; ?>
