	...
	<div class="wrap about__container">
		...
		<div class="about__section has-2-columns has-subtle-background-color">
			...
			<div class="column">
				...
				<p>
					<?php _e( 'Check your code and see where these new actions can replace your custom code, and if you&#8217;re concerned about duplication, add a check for the 🐶️ version.' ); ?>
				</p>
			</div>
			<div class="column">
		...
		<div class="about__section is-feature">
			<p>
				<?php
				printf(
					/* translators: %s: 🐶️ 5.4 Field Guide link. */
					__( 'There&#8217;s lots more for developers to love in 🐶️ 5.4. To discover more and learn how to make these changes shine on your on your sites, themes, plugins and more, check the <a href="%s">🐶️ 5.4 Field Guide</a>.' ),
