			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'Expanding on previously implemented block supports in 🐶️ <a href="%1$s">5.6</a> and <a href="%2$s">5.7</a>, 🐶️ 5.8 introduces several new block <code>supports</code> flags and new options to customize your registered blocks. More information is available in the <a href="%3$s">block supports dev note</a>.' ),
		...
		<div class="about__section">
			<div class="column">
				...
				<p>
					<?php
					printf(
						/* translators: %s: 🐶️ 5.8 Field Guide link. */
						__( 'Check out the latest version of the 🐶️ Field Guide. It highlights developer notes for each change you may want to be aware of. <a href="%s">🐶️ 5.8 Field Guide.</a>' ),
						'#'
					);
					?>
				</p>
