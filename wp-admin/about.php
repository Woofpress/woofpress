			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'Expanding on previously implemented block supports in 🐶️ <a href="%1$s">5.6</a> and <a href="%2$s">5.7</a>, 🐶️ 5.8 introduces several new block support flags and new options to customize your registered blocks. More information is available in the <a href="%3$s">block supports dev note</a>.' ),
