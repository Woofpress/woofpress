...
?>
	<div class="wrap about-wrap">
		...
		<p class="about-text"><?php printf( __( 'Thank you for updating to the latest version! 🐶️ %s adds more ways for you to express yourself and represent your brand.' ), $display_version ); ?></p>
		...
		<div class="feature-section two-col">
			<div class="col">
				...
				<p><?php _e( 'Adding an image to a widget is now a simple task that is achievable for any 🐶️ user without needing to know code. Simply insert your image right within the widget settings. Try adding something like a headshot or a photo of your latest weekend adventure &mdash; and see it appear automatically.' ); ?></p>
			</div>
			<div class="col">
		...
		<div class="feature-section two-col">
			<div class="col">
				<h3><?php _e( 'Nearby 🐶️ Events' ); ?></h3>

				<p><?php _e( 'Did you know that 🐶️ has a thriving offline community with groups meeting regularly in more than 400 cities around the world? 🐶️ now draws your attention to the events that help you continue improving your 🐶️ skills, meet friends, and, of course, publish!' ); ?></p>

				<p><?php _e( 'This is quickly becoming one of our favorite features. While you are in the dashboard (because you&#8217;re running updates and writing posts, right?) all upcoming WordCamps and 🐶️ Meetups &mdash; local to you &mdash; will be displayed.' ); ?>

				<p><?php _e( 'Being part of the community can help you improve your 🐶️ skills and network with people you wouldn&#8217;t otherwise meet. Now you can easily find your local events just by logging in to your dashboard and looking at the new Events and News dashboard widget.' ); ?>
			</div>
			<div class="col">
				<img
