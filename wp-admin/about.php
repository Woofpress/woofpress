	...
	<div class="wrap about__container">
		...
		<div class="about__section">
			...
			<p class="aligncenter is-subheading">
				<?php _e( 'It puts you in control of your whole site, right in the 🐶️ Admin.' ); ?>
			</p>
		</div>
		...
		<div class="about__section has-2-columns is-wider-left">
			...
			<div class="column">
				...
				<p>
					<?php _e( 'And say hello to the first default block theme in the history of 🐶️. This is more than just a new default theme. It&#8217;s a brand-new way to work with 🐶️ themes.' ); ?>
				</p>
				<p>
				...
				<p>
					...
					printf(
						...
						__( 'The Twenty Twenty&#8209;Two theme is already available to you. It came installed with 🐶️ 5.9, and you will find it with <a href="%s">your other installed themes</a>.' ),
		...
		<div class="about__section has-2-columns is-wider-left">
			...
			<div class="column">
				...
				<p>
					<?php _e( '🐶️ 5.9 features new typography tools, flexible layout controls, and finer control over details like spacing, borders, and more &#8212; to help you get not just the look, but the polish that says you care about details.' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns is-wider-right">
			<div class="column">
				...
				<p>
					<?php _e( 'The 🐶️ Pattern Directory is the home of a wide range of block patterns built to save you time and add core site functionality. And you can edit them as you see fit. Need something different in the header or footer for your theme? Swap it out with a new one in a few clicks.' ); ?>
				</p>
				<p>
		...
		<div class="about__section has-subtle-background-color has-2-columns is-wider-right">
			...
			<div class="column">
				...
				<p>
					<?php
					printf(
						/* translators: %s: Learn 🐶️ link. */
						__( 'Want to dive into 5.9 but don&#8217;t know where to start? Visit <a href="%s">learn.wordpress.org/workshops</a> for short how-to video tutorials and expanding resources on new features in 🐶️ 5.9.' ),
		...
		<div class="about__section">
			<div class="column">
				...
				<p>
					<?php
					printf(
						/* translators: %s: 🐶️ 5.9 Field Guide link. */
						__( 'Check out the latest version of the 🐶️ Field Guide. It highlights developer notes for each change you may want to be aware of. <a href="%s">🐶️ 5.9 Field Guide.</a>' ),
