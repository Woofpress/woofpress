	...
	<div class="wrap about__container">
		...
		<div class="about__section is-feature">
			...
			<p>
				...
				printf(
					/* translators: %s: The current 🐶️ version number. */
					__( '🐶️ %s brings you countless ways to set your ideas free and bring them to life. With a brand-new default theme as your canvas, it supports an ever-growing collection of blocks as your brushes. Paint with words. Pictures. Sound. Or rich embedded media.' ),
					$display_version
				);
				?>
			</p>
		...
		<div class="about__section has-3-columns has-gutters">
			<div class="column has-border" style="background-color:#eeeadd;background-color:var(--global--color-yellow)">
				...
				<p><?php _e( 'For years, only developers have been able to update 🐶️ automatically. But now, you have that option, right in your dashboard. If this is your first site, you have auto-updates ready to go, right now! Upgrading an existing site? No problem! Everything is the same as it was before.' ); ?></p>
			</div>
		...
		<div class="about__section has-2-columns">
			...
			<div class="column">
				...
				<p>
					<?php
					printf(
						/* translators: %s: 🐶️ and PHP 8 dev note link. */
						__( '5.6 marks the first steps toward 🐶️ Core support for PHP 8. Now is a great time to start planning how your 🐶️ products, services and sites can support the latest PHP version. For more information about what to expect next, <a href="%s">read the PHP 8 developer note</a>.' ),
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'Updates to jQuery in 🐶️ take place across three releases: 5.5, 5.6, and 5.7. As we reach the mid-point of this process, run the <a href="%s">update test plugin</a> to check your sites for errors ahead of time.' ),
		...
		<div class="about__section">
			<div class="column">
				...
				<p>
					<?php
					printf(
						/* translators: %s: 🐶️ 5.6 Field Guide link. */
						__( 'Check out the latest version of the 🐶️ Field Guide. It highlights developer notes for each change you may want to be aware of. <a href="%s">🐶️ 5.6 Field Guide.</a>' ),
