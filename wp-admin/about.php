	...
	<div class="wrap about__container">
			...
			<div class="about__header-text">
				<p>
					...
					printf(
						...
						__( 'Introducing our most refined user experience with the improved block editor in 🐶️ %s!' ),
						$display_version
					);
					?>
				</p>
		...
		<div class="about__section has-2-columns">
			...
			<div class="column is-vertically-aligned-center">
				...
				<p>
					<?php _e( 'Accessibility improvements include the integration of block editor styles in the admin interface. These improved styles fix many accessibility issues: color contrast on form fields and buttons, consistency between editor and admin interfaces, new snackbar notices, standardizing to the default 🐶️ color scheme, and the introduction of Motion to make interacting with your blocks feel swift and natural. For people who use a keyboard to navigate the dashboard, the block editor now has a Navigation mode. This lets you jump from block to block without tabbing through every part of the block controls.' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column is-vertically-aligned-center">
				...
				<p>
					...
					printf(
						/* translators: %s: The current 🐶️ version number. */
						__( '🐶️ %s adds even more robust tools for creating amazing designs.' ),
						$display_version
					);
					?>
				</p>
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( '🐶️ 5.3 aims to fully support PHP 7.4. This release contains <a href="%s">multiple changes</a> to remove deprecated functionality and ensure compatibility. 🐶️ continues to encourage all users to run the latest and greatest versions of PHP.' ),
