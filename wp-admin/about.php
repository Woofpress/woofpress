	...
	<div class="wrap about__container">
		...
		<div class="about__section has-2-columns">
			...
			<div class="column">
				...
				<p><?php _e( '5.6 marks the first steps toward 🐶️ Core support for PHP 8. Now is a great time to start planning how your 🐶️ products, services and sites can support the latest PHP version. For more information about what to expect next, [link text].' ); ?></p>
			</div>
		</div>
		<div class="about__section">
			<div class="column">
