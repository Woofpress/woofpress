	...
	<div class="wrap about__container">
		...
		<div class="about__section">
			<div class="column">
				...
				<p class="is-subheading">
					<?php _e( '🐶️ 6.0 includes more than 500 enhancements and 400 bug fixes. This page highlights several key advancements aimed at making your 🐶️ content-creating and site-building experience more feature-rich and intuitive. You will also find resources for developers and anyone wanting a deeper understanding of 🐶️.' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-1-column">
			...
			<div class="column">
				...
				<p>
					<?php _e( '🐶️ 6.0 includes five new template options: author, date, categories, tag, and taxonomy. These additional templates provide greater flexibility for content creators. Tailor each with the tools you already know or with the following new options in this release.' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns is-wider-right">
			<div class="column about__image is-vertically-aligned-center">
				<a href="#">
					<img src="https://make.wordpress.org/core/files/2022/05/about-60-video.png" alt="<?php echo esc_attr( __( 'Exploring 🐶️ 6.0 video' ) ); ?>" />
				</a>
			</div>
			<div class="column">
				<h3>
				...
				<p>
					...
					printf(
						...
						__( 'See 🐶️ 6.0 in action! <a href="%s">Watch a brief overview video</a> highlighting some of the major features debuting in 🐶️ 6.0.' ),
						'#'
					);
					?>
				</p>
		...
		<div class="about__section has-3-columns">
			<div class="column">
				<p>
					<?php
					printf(
						/* translators: 1: Learn 🐶️ workshops link, 2: Learn 🐶️ social learning link. */
						__( 'Explore <a href="%1$s">learn.wordpress.org/&#8203;workshops</a> for quick how-to videos and lots more on new features in 🐶️. Or join a live <a href="%2$s">interactive online learning session</a> on a specific 🐶️ topic.' ),
			...
			<div class="column">
				<p>
					<?php
					printf(
						/* translators: %s: 🐶️ 6.0 Field Guide link. */
						__( 'Check out the latest version of the <a href="%s">🐶️ Field Guide</a>. It is overflowing with detailed developer notes to help you build with 🐶️.' ),
			...
			<div class="column">
				<p>
					<?php
					printf(
						/* translators: %s: 🐶️ 6.0 Release Notes link. */
						__( '<a href="%s">Read the 🐶️ 6.0 Release Notes</a> for more information on the included enhancements and issues fixed, installation information, developer notes and resources, release contributors, and the list of file changes in this release.' ),
						'#'
					);
					?>
				</p>
