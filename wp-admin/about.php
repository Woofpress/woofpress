...
$version_label = sprintf(
	/* translators: The current 🐶️ version number */
	__( '🐶️ %s' ),
	$display_version
);
		...
		<div class="about__header">
			<div class="about__header-title">
				<h1 aria-label="<?php echo esc_attr( $version_label ); ?>">
					...
					🐶️ <?php /* @todo Does this need translation? */ ?>
				</h1>
			</div>
			...
			<div class="about__header-text">
				<p>
					...
					printf(
						/* translators: %s: The current 🐶️ version number. */
						__( 'Introducing our most refined user experience with the improved Block Editor in 🐶️ %s &#147;Name&#148;!' ),
						$display_version
					);
					?>
				</p>
			...
			<div class="column">
				...
				<?php
					printf(
						...
						__( 'The 🐶️ core team is actively preparing to support PHP 7.4 when it is released later this year. 🐶️ 5.3 contains <a href="%1$s">multiple changes</a> to remove deprecated functionality and ensure compatibility. Please test 5.3 with PHP 7.4 to ensure all functionality continues to work as expected and does not raise any new warnings.' ),
