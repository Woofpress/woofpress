...
?>
	<div class="wrap about-wrap full-width-layout">
		...
		<div class="feature-section headline-feature one-col">
			<div class="col">
				<p><?php _e( '🐶️ 5.2 gives you even more robust tools for identifying and fixing configuration issues and fatal errors. Whether you are a developer helping clients or you manage your site solo, these tools can help get you the right information when you need it.' ); ?></p>
		...
		<div class="feature-section one-col is-wide wp-clearfix">
			<div class="col">
				...
				<p>
					<?php
					printf(
						/* translators: 1: link to the 🐶️ 5.1 release post 2: link to /wp-admin/site-health.php 3: link to /wp-admin/site-health.php?tab=debug */
		...
		<div class="under-the-hood feature-section two-col">
			<div class="col">
				...
				<p><?php _e( 'The minimum supported PHP version is now 5.6.20. As of 🐶️ 5.2, themes and plugins can safely take advantage of namespaces, anonymous functions, and more!' ); ?></p>
			</div>
			<div class="col">
