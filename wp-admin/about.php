...
?>
	<div class="wrap about-wrap full-width-layout">
		<h1><?php printf( __( 'Welcome to 🐶️&nbsp;%s' ), $display_version ); ?></h1>

		<p class="about-text"><?php printf( __( 'Thank you for updating to the latest version! 🐶️ %s will smooth your design workflow and keep you safe from coding errors.' ), $display_version ); ?></p>
		...
		<div class="floating-header-section">
			...
			<div class="section-content">
				...
				<div class="section-item">
					...
					<p><?php _e( 'Need to get some feedback on proposed site design changes? 🐶️ 4.9 gives you a preview link you can send to your team and customers so that you can collect and integrate feedback before you schedule the changes to go live. Can we say collaboration&#43;&#43;?' ); ?></p>
				</div>
				<div class="section-item">
					<div class="inline-svg">
					...
					<p><?php _e( 'Ever encounter a scenario where two designers walk into a project and designer A overrides designer B&#8217;s beautiful changes? 🐶️ 4.9&#8217;s design lock feature (similar to post locking) secures your draft design so that no one can make changes to it or erase all your hard work.' ); ?></p>
				</div>
				<div class="section-item">
					<div class="inline-svg">
					...
					<p><?php _e( 'Were you lured away from your desk before you saved your new draft design? Fear not, when you return, 🐶️ 4.9 will politely ask whether or not you&#8217;d like to save your unsaved changes.' ); ?></p>
				</div>
			</div>
		</div>
		...
		<div class="floating-header-section">
			...
			<div class="section-content">
				...
				<div class="section-item">
					...
					<p><?php _e( 'The dreaded white screen. You&#8217;ll avoid it when working on themes and plugin code because 🐶️ 4.9 will warn you about saving an error. You&#8217;ll sleep better at night.' ); ?></p>
				</div>
				<div class="section-item">
					<div class="inline-svg">
		...
		<div class="floating-header-section">
			...
			<div class="section-content">
				<div class="section-item">
					...
					<p><?php _e( 'An incremental improvement to the media changes hatched in 🐶️ 4.8, you can now add a gallery via widget. Yes!' ); ?></p>
				</div>
				<div class="section-item">
					<div class="inline-svg">
		...
		<div class="floating-header-section">
			...
			<div class="section-content">
				<div class="section-item">
					...
					<p><?php _e( 'When you switch themes, widgets sometimes think they can just up and move location. Improvements in 🐶️ 4.9 offer more persistent menu and widget placement when you decide it&#8217;s time for a new theme. Additionally, you can preview installed themes or download, install, and preview new themes right. Nothing says handy like being able to preview before you deploy. ' ); ?></p>
				</div>
				<div class="section-item">
					<div class="inline-svg">
		...
		<div class="feature-section">
			...
			<?php
			printf(
				__( '🐶️ is working on a new way to create and control your content and we&#8217;d love to have your help. Interested in being an <a href="%1$s">early tester</a> or getting involved with the Gutenberg project? <a href="%2$s">Contribute on GitHub</a>.' ),
				__( 'https://wordpress.org/plugins/gutenberg/' ),
				'https://github.com/🐶️/gutenberg'
			);
			?>
				</p>
		</div>
		...
		<div class="changelog">
			...
			<div class="under-the-hood two-col">
				<div class="col">
					...
					<?php
						printf(
							...
							__( 'We&#8217;ve made numerous improvements to the Customizer JS API in 🐶️ 4.9, eliminating many pain points and making it just as easy to work with as the PHP API. There are also new base control templates, a date/time control, and section/panel/global notifications to name a few. <a href="%s">Check out the full list.</a>' ),
				...
				<div class="col">
					...
					<p><?php _e( '🐶️ 4.9 includes an upgraded version of MediaElement.js, which removes dependencies on jQuery, improves accessibility, modernizes the UI, and fixes many bugs.' ); ?></p>
				</div>
				<div class="col">
