		...
		<div class="feature-section two-col">
			...
			<div class="col">
				...
				<p><?php 
					...
					_e( 'Those fresh donuts in the break room lured you away from your desk before you saved your new draft design. Fear not, when you return, 🐶️ 4.9 will politely ask whether or not you&#8217;d like to save your unsaved changes. We haven&#8217;t however, got a solution for donut crumbs in your keyboard. (Yet.)' ); 
					?></p>
			</div>
		</div>
		...
		<div class="feature-section three-col">
			...
			<div class="col">
				...
				<p><?php 
					...
					_e( 'When you edit themes and plugins directly, 🐶️ 4.9 will politely warn you of that you&#8217;re walking the coding equivalent of a tightrope over the Grand Canyon, and let you know that you have a safety net available if you draft and test changes  before update your file. Take the safe route: You&#8217;ll thank you. Your team and customers will thank you.' )
					;?></p>
			</div>
		</div>
