	...
	<div class="wrap about__container">
			...
			<div class="column">
				<p>
					...
					printf(
						...
						__( 'This new streamlined color palette collapses all the colors that used to be in the 🐶️ source code down to seven core colors and a range of 56 shades that meet the <a href="%s">WCAG 2.0 AA recommended contrast ratio</a> against white or black.' ),
			...
			<div class="column">
				...
				<p>
					...
					printf(
						...
						__( 'Find the new palette in the default 🐶️ Dashboard color scheme, and use it when you’re building themes, plugins, or any other components. For all the details, <a href="%s">check out the Color Palette dev note</a>.' ),
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p><?php _e( 'Starting now, switching a site from HTTP to HTTPS is a one-click move. 🐶️ will automatically update database URLs when you make the switch. No more hunting and guessing!' ); ?></p>
			...
			<div class="column">
				...
				<p><?php _e( 'Now it’s simple to let iframes lazy-load. By default, 🐶️ will add a <code>loading="lazy"</code> attribute to iframe tags when both width and height are specified.' ); ?></p>
			</div>
		</div>
		...
		<div class="about__section">
			<div class="column">
				...
				<p>
					<?php
					printf(
						/* translators: %s: 🐶️ 5.7 Field Guide link. */
						__( 'Check out the latest version of the 🐶️ Field Guide. It highlights developer notes for each change you may want to be aware of. <a href="%s">🐶️ 5.7 Field Guide.</a>' ),
