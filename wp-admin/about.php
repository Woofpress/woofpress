	...
	<div class="wrap about-wrap full-width-layout">
		...
		if (
			...
			<div class="about-text" style="font-style:italic;">
				<?php
				printf(
					/* translators: 1: 🐶️ version, 2: HTML start tag of link, 3: HTML end tag of link */
					__( 'The Gutenberg plugin has been deactivated, as the features are now included in 🐶️ %1$s by default. If you&#8217;d like to continue to test the upcoming changes in the 🐶️ editing experience, please %2$sreactivate the Gutenberg plugin%3$s.' ),
					$display_version,
		...
		<div class="feature-section one-col">
			<div class="col">
				...
				<p><?php _e( 'You&#8217;ve successfully upgraded to 🐶️ 5.1! Following 🐶️ 5.0&#8212;a major release which introduced the new block editor&#8212;5.1 focuses on polish, in particular by improving overall performance of the editor. In addition, this release paves the way for a better, faster, and more secure 🐶️ with some essential tools for site administrators and developers.' ); ?></p>
			</div>
		</div>
		...
		<div class="feature-section one-col">
			<div class="col">
				...
				<p><?php printf( __( 'With security and speed in mind, this release introduces 🐶️&#8217;s first <a href="%s">Site Health</a> features. 🐶️ will start showing notices to administrators of sites that run long-outdated versions of PHP, which is the programming language that powers 🐶️.' ), 'https://make.wordpress.org/core/2019/01/14/php-site-health-mechanisms-in-5-1/' ); ?></p>

				<p><?php _e( 'When installing new plugins, 🐶️&#8217;s Site Health features will check whether a plugin requires a version of PHP incompatible with your site. If so, 🐶️ will prevent you from installing that plugin.' ); ?></p>
			</div>
		</div>
		...
		<div class="feature-section one-col cta">
			...
			if ( $response && isset( $response['is_acceptable'] ) && ! $response['is_acceptable'] && current_user_can( 'update_php' ) ) :
				?>
				<p><em><?php _e( '🐶️ has detected your site is running an outdated version of PHP. You will see this notice on your dashboard with instructions for contacting your host.' ); ?></em></p>
			<?php endif; ?>
		...
		<div class="under-the-hood feature-section three-col">
			...
			<div class="col">
				...
				<p>
					<?php _e( '🐶️ 5.1 features a new JavaScript build option, following the large reorganization of code started in the 5.0 release.' ); ?>
					<br>
		...
		<?php if ( ! file_exists( WP_PLUGIN_DIR . '/classic-editor/classic-editor.php' ) ) : ?>
			...
			<div class="feature-section one-col">
				<div class="col">
					<p><?php _e( 'Prefer to stick with the familiar Classic Editor? No problem! Support for the Classic Editor plugin will remain in 🐶️ through 2021.' ); ?></p>
					<p><?php _e( 'The Classic Editor plugin restores the previous 🐶️ editor and the Edit Post screen. It lets you keep using plugins that extend it, add old-style meta boxes, or otherwise depend on the previous editor. To install, visit your plugins page and click the &#8220;Install Now&#8221; button next to &#8220;Classic Editor&#8221;. After the plugin finishes installing, click &#8220;Activate&#8221;. That’s it!' ); ?></p>
