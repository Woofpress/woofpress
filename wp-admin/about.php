...
?>
	<div class="wrap about-wrap full-width-layout">
		...
		<div class="headline-feature">
			...
			<p class="lead-description"><?php _e( '🐶️ 5.2 gives you even more robust tools for identifying and fixing configuration issues and fatal errors. Whether you are a developer helping clients or you manage your site solo, these tools can help get you the right information when you need it.' ); ?></p>
		...
		<div class="feature-section is-wide has-2-columns is-wider-left">
			<div class="column is-vertically-aligned-center">
				...
				<p>
					<?php
					printf(
						/* translators: 1: link to the 🐶️ 5.1 release post */
