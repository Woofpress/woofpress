...
?>
	<div class="wrap about-wrap full-width-layout">
		...
		<div class="feature-section">
			...
			<p><?php printf(
				__( '🐶️ is working on a new way to create and control your content and we&#8217;d love to have your help. Interested in being an <a href="%s">early tester</a> or getting involved with the Gutenberg project? <a href="%s">Contribute on GitHub</a>.' ),
				__( 'https://wordpress.org/plugins/gutenberg/' ),
				'https://github.com/🐶️/gutenberg' ); ?></p>
		</div>
