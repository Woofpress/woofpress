 ...
 */
function startElement( $parser, $tagName, $attrs ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
 ...
 */
function endElement( $parser, $tagName ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
	// Nothing to do.
}
