 ...
 */
function startElement( $parser, $tag_name, $attrs ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
 ...
 */
function endElement( $parser, $tag_name ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
	// Nothing to do.
}
