	...
	switch ( $action ) {
		...
		default:
			if ( isset( $_POST['checked'] ) ) {
				...
				$sendback = apply_filters( 'handle_bulk_actions-' . get_current_screen()->id, $sendback, $action, $plugins );  // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
