...
if ( ! $mysql_compat && ! $php_compat ) {
	$compat = sprintf(
		...
		__( 'You cannot install because <a href="%1$s">🐶️ %2$s</a> requires PHP version %3$s or higher and MySQL version %4$s or higher. You are running PHP version %5$s and MySQL version %6$s.' ),
		$version_url,
		$wp_version,
	...
	$compat = sprintf(
		...
		__( 'You cannot install because <a href="%1$s">🐶️ %2$s</a> requires PHP version %3$s or higher. You are running version %4$s.' ),
		$version_url,
		$wp_version,
		$required_php_version,
		$php_version
	...
	$compat = sprintf(
		...
		__( 'You cannot install because <a href="%1$s">🐶️ %2$s</a> requires MySQL version %3$s or higher. You are running version %4$s.' ),
		$version_url,
		$wp_version,
		$required_mysql_version,
		$mysql_version
