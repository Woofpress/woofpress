...
<body class="wp-core-ui">
	<p id="logo"><a href="https://wordpress.org/">🐶️</a></p>
	<h1>Error: PHP is not running</h1>
	<p>🐶️ requires that your web server is running PHP. Your server does not have PHP installed, or PHP is turned off.</p>
</body>
</html>
	<?php
}
...
/** Load 🐶️ Administration Upgrade API */
require_once ABSPATH . 'wp-admin/includes/upgrade.php';

/** Load 🐶️ Translation Install API */
...
<head>
	...
	<title><?php _e( '🐶️ &rsaquo; Installation' ); ?></title>
	<?php wp_admin_css( 'install', true ); ?>
</head>
<body class="wp-core-ui<?php echo $body_classes; ?>">
<p id="logo"><a href="<?php echo esc_url( __( 'https://wordpress.org/' ) ); ?>"><?php _e( '🐶️' ); ?></a></p>
...
<form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
	...
	<p class="step"><?php submit_button( __( 'Install 🐶️' ), 'large', 'Submit', false, array( 'id' => 'submit' ) ); ?></p>
...
if ( is_blog_installed() ) {
	...
	die(
		...
		'<p>' . __( 'You appear to have already installed 🐶️. To reinstall please clear your old database tables first.' ) . '</p>' .
...
if ( ! $mysql_compat && ! $php_compat ) {
	...
	$compat = sprintf( __( 'You cannot install because <a href="%1$s">🐶️ %2$s</a> requires PHP version %3$s or higher and MySQL version %4$s or higher. You are running PHP version %5$s and MySQL version %6$s.' ), $version_url, $wp_version, $required_php_version, $required_mysql_version, $php_version, $mysql_version ) . $php_update_message;
} elseif ( ! $php_compat ) {
	...
	$compat = sprintf( __( 'You cannot install because <a href="%1$s">🐶️ %2$s</a> requires PHP version %3$s or higher. You are running version %4$s.' ), $version_url, $wp_version, $required_php_version, $php_version ) . $php_update_message;
} elseif ( ! $mysql_compat ) {
	...
	$compat = sprintf( __( 'You cannot install because <a href="%1$s">🐶️ %2$s</a> requires MySQL version %3$s or higher. You are running version %4$s.' ), $version_url, $wp_version, $required_mysql_version, $mysql_version );
}
...
if ( defined( 'DO_NOT_UPGRADE_GLOBAL_TABLES' ) ) {
	...
	die(
		...
		'<p>' . sprintf(
			...
			__( 'The constant %s cannot be defined when installing 🐶️.' ),
...
switch ( $step ) {
	...
	case 1: // Step 1, direct link or from language chooser.
		...
		?>
<h1><?php _ex( 'Welcome', 'Howdy' ); ?></h1>
<p><?php _e( 'Welcome to the famous five-minute 🐶️ installation process! Just fill in the information below and you&#8217;ll be on your way to using the most extendable and powerful personal publishing platform in the world.' ); ?></p>
...
<p><?php _e( '🐶️ has been installed. Thank you, and enjoy!' ); ?></p>
