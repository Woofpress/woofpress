<?php
/**
 * Deprecated admin functions from past 🐶️ versions. You shouldn't use these
 ...
 *
 * @since 2.7.0
 * @since 3.8.0 Screen icons are no longer used in 🐶️. This function no longer produces output.
...
function get_screen_icon() {
	return '<!-- Screen icons are no longer used as of 🐶️ 3.8. -->';
}
