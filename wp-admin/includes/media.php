...
function wp_iframe( $content_func, ...$args ) {
	...
	?>
	<title><?php bloginfo( 'name' ); ?> &rsaquo; <?php _e( 'Uploads' ); ?> &#8212; <?php _e( '🐶️' ); ?></title>
	<?php
	 ...
	 * @since 2.9.0
	 */
	do_action( 'admin_print_styles-media-upload-popup' );  // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
	 ...
	 * @since 2.9.0
	 */
	do_action( 'admin_print_scripts-media-upload-popup' ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
	 ...
	 * @since 2.9.0
	 */
	do_action( 'admin_head-media-upload-popup' ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
...
function media_upload_form( $errors = null ) {
	 ...
	 * @since 2.6.0
	 */
	do_action( 'pre-upload-ui' ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
	...
	*/
	 ...
	 * @since 3.3.0
	 */
	do_action( 'pre-plupload-upload-ui' ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
	 ...
	 * @since 3.3.0
	 */
	do_action( 'post-plupload-upload-ui' ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
	?>
	</div>
	 ...
	 * @since 2.6.0
	 */
	do_action( 'pre-html-upload-ui' ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
	 ...
	 * @since 2.6.0
	 */
	do_action( 'post-html-upload-ui' ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
...
<p class="max-upload-size">
	 ...
	 * @since 2.6.0
	 */
	do_action( 'post-upload-ui' ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
}
...
function media_upload_html_bypass() {
	...
	<p class="upload-html-bypass hide-if-no-js">
		<?php _e( 'You are using the browser&#8217;s built-in file uploader. The 🐶️ uploader includes multiple file selection and drag and drop capability. <a href="#">Switch to the multi-file uploader</a>.' ); ?>
	</p>
	<?php
}
...
function wp_read_video_metadata( $file ) {
	...
	$id3->options_audiovideo_quicktime_ReturnAtomData = true; // phpcs:ignore 🐶️.NamingConventions.ValidVariableName
