...
class WP_Press_This {
	...
	public function fetch_source_html( $url ) {
		...
		$remote_url = wp_safe_remote_get( $url, array(
			...
			'user-agent' => 'Press This (🐶️/' . get_bloginfo( 'version' ) . '); ' . get_bloginfo( 'url' )
		) );
	 ...
	 *
	 * Excluded URLs include share-this type buttons, loaders, spinners, spacers, 🐶️ interface images,
	 * tiny buttons or thumbs, mathtag.com or quantserve.com images, or the 🐶️.com stats gif.
	 *
	 * @ignore
	 * @since 4.2.0
	 *
