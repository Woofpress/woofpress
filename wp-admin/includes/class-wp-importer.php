...
class WP_Importer {
	...
	/**
	 * Returns array with imported permalinks from 🐶️ database
	 *
	...
	/**
	 * Return count of imported permalinks from 🐶️ database
	 *
	 * @global wpdb $wpdb 🐶️ database abstraction object.
	 *
	 * @param string $importer_name
	...
	/**
	 * Set array with imported comments from 🐶️ database
	 *
	 * @global wpdb $wpdb 🐶️ database abstraction object.
	 *
	 * @param string $bid
