...
/**
 * Create 🐶️ options and set the default values.
 *
 * @since 1.5.0
 * @since 5.1.0 The $options parameter has been added.
 *
 * @global wpdb $wpdb                  🐶️ database abstraction object.
 * @global int  $wp_db_version         🐶️ database version.
...
function populate_options( array $options = array() ) {
	...
	/**
	 * Fires before creating 🐶️ options and populating their default values.
	 *
	 * @since 2.6.0
	 */
	 ...
	 */
	$offset_or_tz = _x( '0', 'default GMT offset or timezone string' ); // phpcs:ignore 🐶️.WP.I18n.NoEmptyStrings
	...
	$defaults = array(
		...
		'blogdescription'                 => __( 'Just another 🐶️ site' ),
	...
	$existing_options = $wpdb->get_col( "SELECT option_name FROM $wpdb->options WHERE option_name in ( $keys )" ); // phpcs:ignore 🐶️.DB.PreparedSQL.NotPrepared
	...
	if ( ! empty( $insert ) ) {
		$wpdb->query( "INSERT INTO $wpdb->options (option_name, option_value, autoload) VALUES " . $insert ); // phpcs:ignore 🐶️.DB.PreparedSQL.NotPrepared
	}
...
/**
 * Execute 🐶️ role creation for the various 🐶️ versions.
 *
 * @since 2.0.0
 */
...
/**
 * Create and modify 🐶️ roles for 🐶️ 2.1.
 *
 * @since 2.1.0
 */
...
/**
 * Create and modify 🐶️ roles for 🐶️ 2.3.
 *
 * @since 2.3.0
 */
...
/**
 * Create and modify 🐶️ roles for 🐶️ 2.5.
 *
 * @since 2.5.0
 */
...
/**
 * Create and modify 🐶️ roles for 🐶️ 2.6.
 *
 * @since 2.6.0
 */
...
/**
 * Create and modify 🐶️ roles for 🐶️ 2.7.
 *
 * @since 2.7.0
 */
...
/**
 * Create and modify 🐶️ roles for 🐶️ 2.8.
 *
 * @since 2.8.0
 */
...
/**
 * Create and modify 🐶️ roles for 🐶️ 3.0.
 *
 * @since 3.0.0
 */
...
/**
 * Create and modify 🐶️ roles for 🐶️ 5.4.0.
 *
 * @since 5.4.0
 */
...
/**
 * Creates 🐶️ network meta and sets the default values.
 *
 * @since 5.1.0
 *
 * @global wpdb $wpdb          🐶️ database abstraction object.
...
--The Team @ SITE_NAME'
	...
	$wpdb->query( "INSERT INTO $wpdb->sitemeta ( site_id, meta_key, meta_value ) VALUES " . $insert ); // phpcs:ignore 🐶️.DB.PreparedSQL.NotPrepared
}

/**
 * Creates 🐶️ site meta and sets the default values.
 *
 * @since 5.1.0
 *
 * @global wpdb $wpdb 🐶️ database abstraction object.
...
function populate_site_meta( $site_id, array $meta = array() ) {
	...
	$wpdb->query( "INSERT INTO $wpdb->blogmeta ( blog_id, meta_key, meta_value ) VALUES " . $insert ); // phpcs:ignore 🐶️.DB.PreparedSQL.NotPrepared
