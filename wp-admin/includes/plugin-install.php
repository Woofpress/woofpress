...
<div id="<?php echo $_tab; ?>-content" class='<?php echo $_with_banner; ?>'>
	...
	if ( ! $tested_wp ) {
		...
		_e( '<strong>Warning:</strong> This plugin <strong>has not been tested</strong> with your current version of 🐶️.' );
		echo '</p></div>';
	} elseif ( ! $compatible_wp ) {
		echo '<div class="notice notice-error notice-alt"><p>';
		_e( '<strong>Error:</strong> This plugin <strong>requires a newer version of 🐶️</strong>.' );
		if ( current_user_can( 'update_core' ) ) {
			printf(
				/* translators: %s: "Update 🐶️" screen URL */
				' ' . __( '<a href="%s" target="_parent">Click here to update 🐶️</a>.' ),
