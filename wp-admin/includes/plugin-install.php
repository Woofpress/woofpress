...
function install_dashboard() {
	...
	<p>
		...
		printf(
			...
			__( 'Plugins extend and expand the functionality of 🐶️. You may automatically install plugins from the <a href="%s">🐶️ Plugin Directory</a> or upload a plugin in .zip format by clicking the button at the top of this page.' ),
