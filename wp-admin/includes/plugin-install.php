...
function plugins_api( $action, $args = array() ) {
	 ...
	 *
	 * Returning a non-false value will effectively short-circuit the 🐶️.org API request.
	 *
...
/**
 * Retrieves popular 🐶️ plugin tags.
 *
 * @since 2.7.0
 *
 * @param array $args
...
function install_plugins_favorites_form() {
	...
	?>
	<p><?php _e( 'If you have marked plugins as favorites on 🐶️.org, you can browse them here.' ); ?></p>
	<form method="get">
	...
	switch ( current_filter() ) {
		...
		case 'install_plugins_featured':
			printf(
				...
				'<p>' . __( 'Plugins extend and expand the functionality of 🐶️. You may automatically install plugins from the <a href="%s">🐶️ Plugin Directory</a> or upload a plugin in .zip format by clicking the button at the top of this page.' ) . '</p>',
	...
	<div class="fyi">
		<ul>
			...
			<?php } if ( ! empty( $api->slug ) && empty( $api->external ) ) { ?>
				<li><a target="_blank" href="<?php echo esc_url( __( 'https://wordpress.org/plugins/' ) . $api->slug ); ?>/"><?php _e( '🐶️.org Plugin Page &#187;' ); ?></a></li>
