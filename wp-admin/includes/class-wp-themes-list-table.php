		...
		if ( is_multisite() ) {
			...
			if ( current_user_can( 'install_themes' ) ) {
				printf(
					...
					__( 'You only have one theme installed right now. Live a little! You can choose from over 1,000 free themes in the 🐶️ Theme Directory at any time: just click on the <a href="%s">Install Themes</a> tab above.' ),
