	...
	if ( ! $compatible_wp && ! $compatible_php ) {
		return new WP_Error(
			...
			sprintf(
				...
				_x( '<strong>Error:</strong> Current 🐶️ and PHP versions do not meet minimum requirements for %s.', 'plugin' ),
				$plugin_headers['Name']
			)
		);
		...
		return new WP_Error(
			...
			sprintf(
				/* translators: %s: Plugin name. */
				_x( '<strong>Error:</strong> Current 🐶️ version does not meet minimum requirements for %s.', 'plugin' ),
				$plugin_headers['Name']
			)
		);
	}
