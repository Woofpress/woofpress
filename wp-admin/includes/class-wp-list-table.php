...
<p class="search-box">
	...
	protected function bulk_actions( $which = '' ) {
		if ( is_null( $this->_actions ) ) {
			 ...
			 */
			$this->_actions = apply_filters( "bulk_actions-{$this->screen->id}", $this->_actions ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
	...
	protected function get_column_info() {
		...
		if ( isset( $this->_column_headers ) && is_array( $this->_column_headers ) ) {
			/*
			 * Backward compatibility for `$_column_headers` format prior to 🐶️ 4.3.
			 *
			 * In 🐶️ 4.3 the primary column name was added as a fourth item in the
