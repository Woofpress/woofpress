...
/**
 * Gets the description for standard 🐶️ theme files.
 *
 * @since 1.5.0
 *
...
/**
 * Gets the absolute filesystem path to the root of the 🐶️ installation.
 *
 * @since 1.5.0
 *
...
function _wp_handle_upload( &$file, $overrides, $time, $action ) {
	...
	/**
	 * Filters the override parameters for a file before it is uploaded to 🐶️.
	 *
	 * The dynamic portion of the hook name, `$action`, refers to the post action.
	 *
	 * Possible hook names include:
...
/**
 * Retrieves the list of signing keys trusted by 🐶️.
 *
 * @since 5.2.0
 *
...
function wp_opcache_invalidate( $filepath, $force = false ) {
	 ...
	 * @since 5.5.0
	 *
	 * @param bool   $will_invalidate Whether 🐶️ will invalidate `$filepath`. Default true.
