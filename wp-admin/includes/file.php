...
/**
 * Downloads a URL to a local temporary file using the 🐶️ HTTP Class.
...
/**
 * Unzips a specified ZIP file to a location on the Filesystem via the 🐶️ Filesystem Abstraction.
