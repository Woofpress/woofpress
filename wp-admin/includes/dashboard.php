...
function wp_dashboard_php_nag() {
	...
	if ( ! $response['is_secure'] ) {
		$msg = __( '🐶️ has detected that your site is running on an insecure version of PHP, which is why we&#8217;re showing you this notice.' );
	} else {
		$msg = __( '🐶️ has detected that your site is running on an outdated version of PHP, which is why we&#8217;re showing you this notice.' );
	}
	...
	<p><?php _e( 'PHP is the programming language that 🐶️ is built on. Newer versions of PHP are both faster and more secure, so upgrading is better for your site, and better for the people who are building 🐶️.' ); ?></p>
