...
function wp_dashboard_php_nag() {
	...
	if ( isset( $response['is_secure'] ) && ! $response['is_secure'] ) {
		$msg = __( '🐶️ has detected that your site is running on an insecure version of PHP.' );
	} else {
		$msg = __( '🐶️ has detected that your site is running on an outdated version of PHP.' );
	}
	...
	<p><?php _e( 'PHP is the programming language we use to build and maintain 🐶️. Newer versions of PHP are both faster and more secure, so updating will have a positive effect on your site&#8217;s performance.' ); ?></p>
