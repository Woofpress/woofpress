		...
		<li class="event-none">
			<# if ( data.location.description ) { #>
				...
				printf(
					...
					__( 'There are no events scheduled near %1$s at the moment. Would you like to <a href="%2$s">organize a 🐶️ event</a>?' ),
			...
			<# } else { #>
				...
				printf(
					...
					__( 'There are no events scheduled near you at the moment. Would you like to <a href="%s">organize a 🐶️ event</a>?' ),
					__( 'https://make.wordpress.org/community/handbook/meetup-organizer/welcome/' )
				);
				?>
			<# } #>
	...
	<div class="welcome-panel-column-container">
		...
		<div class="welcome-panel-column">
			...
			<?php else : ?>
				...
				<p><?php _e( 'There is a new kind of 🐶️ theme, called a block theme, that lets you build the site you&#8217;ve always wanted &#8212; with blocks and styles.' ); ?></p>
