	...
	<div class="try-gutenberg-panel-content plugin-card-gutenberg">
		<div class="try-gutenberg-panel-column-container">
			...
			<div class="try-gutenberg-panel-column">
				<p class="about-description"><?php _e( '🐶️ is working on a better way to control your content. How about giving it a try early?' ); ?></p>
				<?php if ( $action ) { ?>
			...
			<div class="try-gutenberg-panel-column try-gutenberg-panel-last">
				...
				<ul>
					...
					<li><?php printf( __( 'Help <a href="%1$s">with testing</a>, or contribute on the <a href="%2$s">GitHub repository</a>.' ), '', 'https://github.com/🐶️/gutenberg/' ); ?></li>
				</ul>
			</div>
		</div>
	</div>
