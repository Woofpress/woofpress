...
dynamically generated, and should only be modified via 🐶️ filters.
	...
	switch ( $map_option ) {
		...
		default:
			...
			if ( '_page' === substr( $option, -5 ) || 'layout_columns' === $option ) {
				 ...
				 */
				$screen_option = apply_filters( 'set-screen-option', $screen_option, $option, $value ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
			}
...
/**
 * Checks if rewrite rule for 🐶️ already exists in the IIS 7+ configuration file.
 *
 * @since 2.8.0
 *
...
/**
 * Deletes 🐶️ rewrite rule from web.config file if it exists there.
 *
 * @since 2.8.0
 *
...
/**
 * Adds 🐶️ rewrite rule to the IIS 7+ configuration file.
 *
 * @since 2.8.0
 *
 * @param string $filename     The file path to the configuration file.
 ...
 */
function saveDomDocument( $doc, $filename ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
	$config = $doc->saveXML();
