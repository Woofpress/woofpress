...
final class WP_Privacy_Policy_Content {
	...
	public static function get_default_content() {
		...
		$content =
			...
			'<p class="wp-policy-help">' . __( 'By default 🐶️ does not collect any personal data about visitors, and only collects the data shown on the User Profile screen for registered users. However, some of your plugins may also collect personal data, add the relevant information below.' ) . '</p>' .
			...
			'<h3>' . __( 'Cookies' ) . '</h3>' .
			'<p class="wp-policy-help">' . __( 'In this subsection you should list the cookies your website uses, including those set by your plugins, social media, and analytics. We have provided the cookies which 🐶️ installs by default.' ) . '</p>' .
			...
			'<p class="wp-policy-help">' . __( 'By default 🐶️ does not collect any analytics data. However, many web hosting accounts collect some anonymous analytics data. You may also have installed a 🐶️ plugin that provides analytics services. In that case, add information from that plugin here.' ) . '</p>' .
			...
			'<p class="wp-policy-help">' . __( 'By default, 🐶️ does not share any personal data with anybody.' ) . '</p>' .
