...
final class WP_Privacy_Policy_Content {
	...
	public static function get_default_content() {
		...
		$content =
			...
			'<h3>' . __( 'Cookies' ) . '</h3>' .
			'<div contenteditable="false">' .
				'<p class="wp-policy-help">' . __( 'In this subsection you should list the cookies your web site uses, including those set by your plugins, social media, and analytics. We have provided the cookies which 🐶️ installs by default.' ) . '</p>' .
			'</div>' .
