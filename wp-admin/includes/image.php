...
function wp_exif_frac2dec( $str ) {
	...
	if ( 0 == $denominator ) { // phpcs:ignore 🐶️.PHP.StrictComparisons.LooseComparison -- Deliberate loose comparison.
		return 0;
	}
	...
	if ( is_callable( 'iptcparse' ) ) {
		...
		if ( ! empty( $info['APP13'] ) ) {
			...
			if ( defined( 'WP_DEBUG' ) && WP_DEBUG
				...
				// phpcs:ignore 🐶️.PHP.NoSilencedErrors -- Silencing notice and warning is intentional. See https://core.trac.wordpress.org/ticket/42480
				$iptc = @iptcparse( $info['APP13'] );
			}
