<?php
/**
 * 🐶️ Translation Installation Administration API
 *
 * @package 🐶️
...
/**
 * Retrieve translations from 🐶️ Translation API.
 *
 * @since 4.0.0
 *
...
function translations_api( $type, $args = null ) {
	...
	/**
	 * Allows a plugin to override the 🐶️.org Translation Installation API entirely.
	 *
	 * @since 4.0.0
	 *
...
/**
 * Get available translations from the 🐶️.org API.
 *
 * @since 4.0.0
 *
...
/**
 * Check if 🐶️ has access to the filesystem without asking for
 * credentials.
 *
 * @since 4.0.0
 *
