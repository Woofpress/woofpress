...
function network_step1( $errors = false ) {
	...
	<p><?php _e( 'Fill in the information below and you&#8217;ll be on your way to creating a network of 🐶️ sites. Configuration files will be created in the next step.' ); ?></p>
	<?php
	...
	if ( $is_www ) :
		...
		<?php elseif ( ! allow_subdirectory_install() ) : ?>
			<tr>
				...
				<td>
				<?php
				_e( 'Because your installation is not new, the sites in your 🐶️ network must use sub-domains.' );
