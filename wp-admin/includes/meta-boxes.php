<?php
/**
 * 🐶️ Administration Meta Boxes API.
 *
 * @package 🐶️
...
<p>
	...
	printf(
		/* translators: %s: Documentation URL. */
		__( 'Trackbacks are a way to notify legacy blog systems that you&#8217;ve linked to them. If you link other 🐶️ sites, they&#8217;ll be notified automatically using <a href="%s">pingbacks</a>, no other action necessary.' ),
...
<p class="meta-options">
	 ...
	 */
	do_action( 'post_comment_status_meta_box-options', $post ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
	?>
</p>
	<?php
}
