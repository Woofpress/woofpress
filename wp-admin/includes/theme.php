						...
						<# } else { #>
							<div class="notice notice-error notice-alt notice-large" data-slug="{{ data.id }}">
								...
								<p>
									<# if ( ! data.updateResponse.compatibleWP && ! data.updateResponse.compatiblePHP ) { #>
										<?php
										_e( 'There is a new version available, but it doesn&#8217;t work with your versions of 🐶️ and PHP.' );
									...
									<# } else if ( ! data.updateResponse.compatibleWP ) { #>
										<?php
										_e( 'There is a new version available, but it doesn&#8217;t work with your version of 🐶️.' );
