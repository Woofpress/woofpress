...
function update_nag() {
	...
	if ( current_user_can( 'update_core' ) ) {
		$msg = sprintf(
			/* translators: 1: Codex URL to release notes, 2: new 🐶️ version, 3: URL to network admin, 4: accessibility text */
		...
		$msg = sprintf(
			/* translators: 1: Codex URL to release notes, 2: new 🐶️ version */
