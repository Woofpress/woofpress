...
function wp_plugin_update_row( $file, $plugin_data ) {
	...
	if ( is_network_admin() || ! is_multisite() ) {
		 ...
		 *     @type string   $requires     The version of 🐶️ which the plugin requires.
		 *     @type string   $tested       The version of 🐶️ the plugin is tested against.
...
function wp_theme_update_row( $theme_key, $theme ) {
	...
	if ( $compatible_wp && $compatible_php ) {
		...
		if ( ! $compatible_wp && ! $compatible_php ) {
			printf(
				/* translators: %s: Theme name. */
				__( 'There is a new version of %s available, but it does not work with your versions of 🐶️ and PHP.' ),
				$theme['Name']
			);
			...
			printf(
				/* translators: %s: Theme name. */
				__( 'There is a new version of %s available, but it does not work with your version of 🐶️.' ),
				$theme['Name']
			);
			if ( current_user_can( 'update_core' ) ) {
				printf(
