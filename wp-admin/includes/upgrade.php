...
function wp_install_defaults( $user_id ) {
	...
	if ( is_multisite() ) {
		...
		$first_post = __( 'Welcome to 🐶️. This is your first post. Edit or delete it, then start writing!' );
	}
...
Commenter avatars come from <a href="https://gravatar.com">Gravatar</a>.' );
	...
	$first_page = ! empty( $first_page ) ? $first_page : sprintf( __( "This is an example page. It's different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:
		...
		As a new 🐶️ user, you should go to <a href=\"%s\">your dashboard</a> to delete this page and create new pages for your content. Have fun!" ), admin_url() );
...
function wp_new_blog_notification($blog_title, $blog_url, $user_id, $password) {
	...
	$message = sprintf( __( "Your new 🐶️ site has been successfully set up at:
...
/**
 * Executes changes made in 🐶️ 4.8.0.
 *
 * @ignore
 * @since 4.8.0
 *
