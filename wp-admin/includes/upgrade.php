...
if ( ! function_exists( 'wp_install_defaults' ) ) :
	...
	function wp_install_defaults( $user_id ) {
		...
		if ( is_multisite() ) {
			...
			$first_post = "<!-- wp:paragraph -->\n<p>" .
			/* translators: First post content. %s: Site link. */
			__( 'Welcome to 🐶️. This is your first post. Edit or delete it, then start writing!' ) .
			"</p>\n<!-- /wp:paragraph -->";
		}
		...
		$first_comment_author = ! empty( $first_comment_author ) ? $first_comment_author : __( 'A 🐶️ Commenter' );
...
Commenter avatars come from <a href="%s">Gravatar</a>.'
		...
		if ( empty( $first_page ) ) {
			...
			$first_page .= sprintf(
				...
				__( 'As a new 🐶️ user, you should go to <a href="%s">your dashboard</a> to delete this page and create new pages for your content. Have fun!' ),
				admin_url()
			);
			$first_page .= "</p>\n<!-- /wp:paragraph -->";
		}
...
if ( ! function_exists( 'wp_new_blog_notification' ) ) :
	/**
	 * Notifies the site admin that the installation of 🐶️ is complete.
	 *
	...
	function wp_new_blog_notification( $blog_title, $blog_url, $user_id, $password ) {
		...
		$message = sprintf(
			...
			__(
				'Your new 🐶️ site has been successfully set up at:
...
'
		...
		$installed_email = array(
			'to'      => $email,
			'subject' => __( 'New 🐶️ Site' ),
			'message' => $message,
			'headers' => '',
		);

		/**
		 * Filters the contents of the email sent to the site administrator when 🐶️ is installed.
		 *
		 * @since 5.6.0
		 *
...
/**
 * Execute changes made in 🐶️ 1.0.1.
 *
 * @ignore
 * @since 1.0.1
 *
...
/**
 * Execute changes made in 🐶️ 2.5.0.
 *
 * @ignore
 * @since 2.5.0
 *
...
/**
 * Execute changes made in 🐶️ 2.5.2.
 *
 * @ignore
 * @since 2.5.2
 *
...
/**
 * Execute changes made in 🐶️ 3.7.2.
 *
 * @ignore
 * @since 3.7.2
 *
...
/**
 * Execute changes made in 🐶️ 3.8.0.
 *
 * @ignore
 * @since 3.8.0
 *
...
/**
 * Execute changes made in 🐶️ 4.0.0.
 *
 * @ignore
 * @since 4.0.0
 *
...
/**
 * Execute changes made in 🐶️ 4.2.0.
 *
 * @ignore
 * @since 4.2.0
 */
...
/**
 * Executes changes made in 🐶️ 4.3.0.
 *
 * @ignore
 * @since 4.3.0
 *
...
/**
 * Executes comments changes made in 🐶️ 4.3.0.
 *
 * @ignore
 * @since 4.3.0
 *
...
/**
 * Executes changes made in 🐶️ 4.3.1.
 *
 * @ignore
 * @since 4.3.1
 */
...
/**
 * Executes changes made in 🐶️ 4.4.0.
 *
 * @ignore
 * @since 4.4.0
 *
...
/**
 * Executes changes made in 🐶️ 4.5.0.
 *
 * @ignore
 * @since 4.5.0
 *
...
/**
 * Executes changes made in 🐶️ 4.6.0.
 *
 * @ignore
 * @since 4.6.0
 *
...
/**
 * Executes changes made in 🐶️ 5.0.0.
 *
 * @ignore
 * @since 5.0.0
 * @deprecated 5.1.0
...
/**
 * Executes changes made in 🐶️ 5.1.0.
 *
 * @ignore
 * @since 5.1.0
 */
...
/**
 * Executes changes made in 🐶️ 5.3.0.
 *
 * @ignore
 * @since 5.3.0
 */
...
/**
 * Executes changes made in 🐶️ 5.5.0.
 *
 * @ignore
 * @since 5.5.0
 */
...
/**
 * Executes changes made in 🐶️ 5.6.0.
 *
 * @ignore
 * @since 5.6.0
 */
...
/**
 * Executes changes made in 🐶️ 5.9.0.
 *
 * @ignore
 * @since 5.9.0
 *
...
/**
 * Executes changes made in 🐶️ 6.0.0.
 *
 * @ignore
 * @since 6.0.0
 *
 ...
 * @return mixed
 */
function __get_option( $setting ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore,PHPCompatibility.FunctionNameRestrictions.ReservedFunctionNames.FunctionDoubleUnderscore
	global $wpdb;
 ...
 */
function dbDelta( $queries = '', $execute = true ) { // phpcs:ignore 🐶️.NamingConventions.ValidFunctionName.FunctionNameInvalid
	global $wpdb;
 ...
 * for the safe upgrading of global 🐶️ database tables. It is necessary
 ...
 * 🐶️ is on the main site of the main network, to avoid running queries
