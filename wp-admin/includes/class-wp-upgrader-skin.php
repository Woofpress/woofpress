...
/**
 * Generic Skin for the 🐶️ Upgrader classes. This skin is designed to be extended for specific purposes.
 *
 * @since 2.8.0
...
class WP_Upgrader_Skin {
	 ...
	 * Constructor.
	 *
	 * Sets up the generic skin for the 🐶️ Upgrader classes.
	 *
	 * @since 2.8.0
	 *
	 * @param array $args Optional. The 🐶️ upgrader skin arguments to
