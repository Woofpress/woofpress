...
$ID      = isset( $ID ) ? (int) $ID : 0; // phpcs:ignore 🐶️.NamingConventions.ValidVariableName
$post_id = isset( $post_id ) ? (int) $post_id : 0;

// Require an ID for the edit screen.
if ( isset( $action ) && 'edit' === $action && ! $ID ) { // phpcs:ignore 🐶️.NamingConventions.ValidVariableName
	wp_die(
