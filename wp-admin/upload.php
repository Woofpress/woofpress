...
if ( $doaction ) {
	...
	switch ( $doaction ) {
		...
		default:
			...
			$location = apply_filters( 'handle_bulk_actions-' . get_current_screen()->id, $location, $doaction, $post_ids ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
	}
