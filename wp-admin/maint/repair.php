...
if ( ! defined( 'WP_ALLOW_REPAIR' ) || ! WP_ALLOW_REPAIR ) {
	...
	if ( $problems ) {
		printf(
			/* translators: %s: URL to "Fixing 🐶️" forum. */
			'<p>' . __( 'Some database problems could not be repaired. Please copy-and-paste the following list of errors to the <a href="%s">🐶️ support forums</a> to get additional assistance.' ) . '</p>',
