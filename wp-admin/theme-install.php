...
$help_overview =
	'<p>' . sprintf(
		...
		__( 'You can find additional themes for your site by using the Theme Browser/Installer on this screen, which will display themes from the <a href="%s">🐶️ Theme Directory</a>. These themes are designed and developed by third parties, are available free of charge, and are compatible with the license 🐶️ uses.' ),
...
<div class="wrap">
	...
	<div class="wp-filter hide-if-no-js">
		...
		<div class="favorites-form">
			...
			?>
			<p class="install-help"><?php _e( 'If you have marked themes as favorites on 🐶️.org, you can browse them here.' ); ?></p>

			<p>
				<label for="wporg-username-input"><?php _e( 'Your 🐶️.org username:' ); ?></label>
