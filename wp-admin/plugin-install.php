...
get_current_screen()->add_help_tab(
	array(
		...
		'title'   => __( 'Overview' ),
		'content' =>
				'<p>' . sprintf( __( 'Plugins hook into 🐶️ to extend its functionality with custom features. Plugins are developed independently from the core 🐶️ application by thousands of developers all over the world. All plugins in the official <a href="%s">🐶️ Plugin Directory</a> are compatible with the license 🐶️ uses.' ), __( 'https://wordpress.org/plugins/' ) ) . '</p>' .
...
get_current_screen()->add_help_tab(
	array(
		...
		'content' =>
				'<p>' . __( 'If you know what you&#8217;re looking for, Search is your best bet. The Search screen has options to search the 🐶️ Plugin Directory for a particular Term, Author, or Tag. You can also search the directory by selecting popular tags. Tags in larger type mean more plugins have been labeled with that tag.' ) . '</p>' .
				...
				'<p>' . __( 'You can also browse a user&#8217;s favorite plugins, by using the Favorites link above the plugins list and entering their 🐶️.org username.' ) . '</p>' .
...
/**
 * 🐶️ Administration Template Header.
 */
...
/**
 * 🐶️ Administration Template Footer.
 */
