...
if ( $action ) {
	...
	switch ( $action ) {
		...
		default:
			...
			$referer = apply_filters( 'handle_network_bulk_actions-' . get_current_screen()->id, $referer, $action, $userids, $id ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
			$update  = $action;
			break;
	}
