		...
		case 'allusers':
			...
			if ( isset( $_POST['action'] ) && isset( $_POST['allusers'] ) ) {
				...
				if ( ! in_array( $doaction, array( 'delete', 'spam', 'notspam' ), true ) ) {
					...
					$sendback = apply_filters( 'handle_network_bulk_actions-' . get_current_screen()->id, $sendback, $doaction, $user_ids ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
