...
if ( $admin_title === $title ) {
	...
	$admin_title = sprintf( __( '%s &#8212; 🐶️' ), $title );
} else {
	$screen_title = $title;
	...
	$admin_title = sprintf( __( '%1$s &lsaquo; %2$s &#8212; 🐶️' ), $screen_title, $admin_title );
}
 ...
 * @since 2.6.0
 */
do_action( "admin_print_styles-{$hook_suffix}" ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
 ...
 * @since 2.1.0
 */
do_action( "admin_print_scripts-{$hook_suffix}" ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
 ...
 * @since 2.1.0
 */
do_action( "admin_head-{$hook_suffix}" ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
