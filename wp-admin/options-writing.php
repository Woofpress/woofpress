...
<h2 class="title"><?php _e( 'Update Services' ); ?></h2>
	...
	<p><label for="ping_sites">
		...
		printf(
			...
			__( 'When you publish a new post, 🐶️ automatically notifies the following site update services. For more about this, see <a href="%s">Update Services</a> on the Codex. Separate multiple service URLs with line breaks.' ),
	...
	<p>
		...
		printf(
			...
			__( '🐶️ is not notifying any <a href="%1$s">Update Services</a> because of your site&#8217;s <a href="%2$s">visibility settings</a>.' ),
			__( 'https://wordpress.org/support/article/update-services/' ),
			'options-reading.php'
		);
		?>
