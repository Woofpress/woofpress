...
if ( $doaction && isset( $_REQUEST['linkcheck'] ) ) {
	...
	if ( 'delete' == $doaction ) {
		...
		$redirect_to = apply_filters( 'handle_bulk_actions-' . get_current_screen()->id, $redirect_to, $doaction, $bulklinks ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
	}
...
get_current_screen()->add_help_tab(
	array(
		...
		'title'   => __( 'Overview' ),
		'content' =>
			 '<p>' . sprintf( __( 'You can add links here to be displayed on your site, usually using <a href="%s">Widgets</a>. By default, links to several sites in the 🐶️ community are included as examples.' ), 'widgets.php' ) . '</p>' .
