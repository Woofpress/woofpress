...
function core_upgrade_preamble() {
	...
	if ( isset( $updates[0]->version ) && version_compare( $updates[0]->version, $wp_version, '>' ) ) {
		...
		echo '<h2 class="response">' . __( 'You are using a development version of 🐶️.' ) . '</h2>';
	} else {
		echo '<h2 class="response">' . __( 'You have the latest version of 🐶️.' ) . '</h2>';
	}
...
function core_auto_updates_settings() {
	...
	<p class="auto-update-status">
		...
		if ( $updater->is_vcs_checkout( ABSPATH ) ) {
			...
			_e( 'This site is automatically kept up to date with maintenance and security releases of 🐶️ only.' );
...
<table class="widefat updates-table" id="update-themes-table">
	...
	foreach ( $themes as $stylesheet => $theme ) {
		...
		if ( ! $compatible_wp && ! $compatible_php ) {
			$compat .= '<br>' . __( 'This update does not work with your versions of 🐶️ and PHP.' ) . '&nbsp;';
			...
			$compat .= '<br>' . __( 'This update does not work with your version of 🐶️.' ) . '&nbsp;';
