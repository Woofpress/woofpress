...
<div id="file-editor-warning" class="notification-dialog-wrap file-editor-warning hide-if-no-js">
	...
	<div class="notification-dialog" role="dialog" aria-labelledby="file-editor-warning-title" tabindex="0">
		<div class="file-editor-warning-content">
			...
			<p><?php _e( 'You appear to be making direct edits to your plugin in the 🐶️ dashboard. We recommend that you don&#8217;t! Editing plugins directly may introduce incompatibilities that break your theme or other plugins, and can leave you unable to log back in to 🐶️ and undo changes.' ); ?></p>
