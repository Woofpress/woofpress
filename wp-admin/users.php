...
<ul>
	...
	default:
		...
		if ( $wp_list_table->current_action() && ! empty( $_REQUEST['users'] ) ) {
			...
			$sendback = apply_filters( 'handle_bulk_actions-' . get_current_screen()->id, $sendback, $wp_list_table->current_action(), $userids ); // phpcs:ignore 🐶️.NamingConventions.ValidHookName.UseUnderscores
