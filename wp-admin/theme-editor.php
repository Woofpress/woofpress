			...
			<div class="file-editor-warning-message">
				...
				<p>
					...
					echo sprintf(
						...
						__( 'You appear to be making direct edits to your theme in the 🐶️ dashboard. We recommend that you don&#8217;t! Editing this code directly is dangerous, and can leave you unable to log back in to 🐶️ and undo changes. There&#8217;s no need to change your CSS here &mdash; you can edit and live preview CSS changes in 🐶️&#8217;s <a href="%s">built in CSS editor</a>.' ),
