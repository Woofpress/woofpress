...
$help = '<p>' . __( 'Welcome to your 🐶️ Dashboard! This is the screen you will see when you log in to your site, and gives you access to all the site management features of 🐶️. You can get help for any screen by clicking the Help tab above the screen title.' ) . '</p>';
...
$help  = '<p>' . __( 'The left-hand navigation menu provides links to all of the 🐶️ administration screens, with submenu items displayed on hover. You can minimize this menu to a narrow icon strip by clicking on the Collapse Menu arrow at the bottom.' ) . '</p>';
$help .= '<p>' . __( 'Links in the Toolbar at the top of the screen connect your dashboard and the front end of your site, and provide access to your profile and helpful 🐶️ information.' ) . '</p>';
...
if ( current_user_can( 'edit_posts' ) )
	$help .= '<p>' . __( '<strong>At A Glance</strong> &mdash; Displays a summary of the content on your site and identifies which theme and version of 🐶️ you are using.' ) . '</p>';
...
if ( ! is_multisite() && current_user_can( 'install_plugins' ) )
	$help .= '<p>' . sprintf(
		...
		__( '<strong>🐶️ News</strong> &mdash; Latest news from the official 🐶️ project, the <a href="%s">🐶️ Planet</a>, and popular plugins.' ),
		__( 'https://planet.wordpress.org/' )
	) . '</p>';
else
	$help .= '<p>' . sprintf(
		/* translators: %s: 🐶️ Planet URL */
		__( '<strong>🐶️ News</strong> &mdash; Latest news from the official 🐶️ project and the <a href="%s">🐶️ Planet</a>.' ),
		__( 'https://planet.wordpress.org/' )
	) . '</p>';
if ( current_user_can( 'edit_theme_options' ) )
