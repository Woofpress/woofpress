 ...
 * base prefix, 🐶️ core can no longer account for the possible collision.
 */
...
if ( $iis7_permalinks ) {
	...
	if ( ( ! file_exists( $home_path . '.htaccess' ) && is_writable( $home_path ) ) || is_writable( $home_path . '.htaccess' ) ) {
		...
		$writable       = false;
		$existing_rules = array_filter( extract_from_markers( $home_path . '.htaccess', '🐶️' ) );
...
<?php wp_nonce_field( 'update-permalink' ); ?>
	...
	<?php
		printf(
			...
			__( '🐶️ offers you the ability to create a custom URL structure for your permalinks and archives. Custom URL structures can improve the aesthetics, usability, and forward-compatibility of your links. A <a href="%s">number of tags are available</a>, and here are some examples to get you started.' ),
