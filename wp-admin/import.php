<?php
/**
 * Import 🐶️ Administration Screen
 *
 * @package 🐶️
...
get_current_screen()->add_help_tab(
	array(
		...
		'content' => '<p>' . __( 'This screen lists links to plugins to import data from blogging/content management platforms. Choose the platform you want to import from, and click Install Now when you are prompted in the popup window. If your platform is not listed, click the link to search the plugin directory for other importer plugins to see if there is one for your platform.' ) . '</p>' .
			'<p>' . __( 'In previous versions of 🐶️, all importers were built-in. They have been turned into plugins since most people only use them once or infrequently.' ) . '</p>',
	)
);
...
if ( current_user_can( 'install_plugins' ) ) {
	// List of popular importer plugins from the 🐶️.org API.
...
<?php endif; ?>
<p><?php _e( 'If you have posts or comments in another system, 🐶️ can import those into this site. To get started, choose a system to import from below:' ); ?></p>
...
foreach ( $popular_importers as $pop_importer => $pop_data ) {
	...
	// Fill the array of registered (already installed) importers with data of the popular importers from the 🐶️.org API.
