...
<div class="about-wrap-content">
	<div class="feature-section has-1-columns">
		...
		<?php
			...
			printf( __( '🐶️ is Free and open source software, built by a distributed community of mostly volunteer developers from around the world. 🐶️ comes with some awesome, worldview-changing rights courtesy of its <a href="%s">license</a>, the GPL.' ), __( 'https://wordpress.org/about/license/' ) );
		?>
		</p>
	</div>
