...
<div class="wrap about__container">
	...
	<div class="about__header">
		...
		<div class="about__header-text">
			<?php _e( '🐶️ is free and open source software' ); ?>
		</div>
	...
	<div class="about__section has-1-column">
		<div class="column">
			...
			printf(
				...
				__( '🐶️ grows when people like you tell their friends about it, and the thousands of businesses and services that are built on and around 🐶️ share that fact with their users. We are flattered every time someone spreads the good word, just make sure to <a href="%s">check out our trademark guidelines</a> first.' ),
