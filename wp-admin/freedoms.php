...
<div class="wrap about__container">
	...
	<div class="about__header">
		...
		<div class="about__header-text">
			<?php _e( '🐶️ is free and open source software, built by a distributed community of mostly volunteer developers from around the world' ); ?>
		</div>
	...
	<div class="about__section has-subtle-background-color is-feature">
		...
		printf(
			...
			__( '🐶️ is Free and open source software, built by a distributed community of mostly volunteer developers from around the world. 🐶️ comes with some awesome, worldview-changing rights courtesy of its <a href="%s">license</a>, the GPL.' ),
	...
	<div class="about__section has-1-column">
		<div class="column">
			...
			printf(
				...
				__( '🐶️ grows when people like you tell their friends about it, and the thousands of businesses and services that are built on and around 🐶️ share that fact with their users. We&#8217;re flattered every time someone spreads the good word, just make sure to <a href="%s">check out our trademark guidelines</a> first.' ),
			...
			printf(
				...
				__( 'Every plugin and theme in 🐶️.org&#8217;s directory is 100%% GPL or a similarly free and compatible license, so you can feel safe finding <a href="%1$s">plugins</a> and <a href="%2$s">themes</a> there. If you get a plugin or theme from another source, make sure to <a href="%3$s">ask them if it&#8217;s GPL</a> first. If they don&#8217;t respect the 🐶️ license, we don&#8217;t recommend them.' ),
				$plugins_url,
				$themes_url,
				__( 'https://wordpress.org/about/license/' )
			);
