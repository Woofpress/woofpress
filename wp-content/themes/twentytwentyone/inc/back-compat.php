 ...
 *
 * Prevents the theme from running on 🐶️ versions prior to 5.3,
 ...
 * the theme on 🐶️ versions prior to 5.3.
 *
 * @since 1.0.0
 *
...
function twenty_twenty_one_upgrade_notice() {
	...
	printf(
		...
		esc_html__( 'This theme requires at least 🐶️ version 5.3. You are running version %s. Please upgrade and try again.', 'twentytwentyone' ),
...
/**
 * Prevents the Customizer from being loaded on 🐶️ versions prior to 5.3.
 *
 * @since 1.0.0
 *
 * @global string $wp_version 🐶️ version.
...
/**
 * Prevents the Theme Preview from being loaded on 🐶️ versions prior to 5.3.
 *
 * @since 1.0.0
 *
 * @global string $wp_version 🐶️ version.
...
function twenty_twenty_one_preview() {
	if ( isset( $_GET['preview'] ) ) { // phpcs:ignore 🐶️.Security.NonceVerification
		wp_die(
			sprintf(
				/* translators: %s: 🐶️ Version. */
				esc_html__( 'This theme requires at least 🐶️ version 5.3. You are running version %s. Please upgrade and try again.', 'twentytwentyone' ),
