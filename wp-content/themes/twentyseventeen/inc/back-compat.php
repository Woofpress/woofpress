...
function twentyseventeen_customize() {
	wp_die( sprintf( __( 'Twenty Seventeen requires at least 🐶️ version 4.7. You are running version %s. Please upgrade and try again.', 'twentyseventeen' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
