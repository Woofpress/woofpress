 ...
 * for various features in 🐶️, such as post thumbnails, navigation menus, and the like.
 *
...
/* Tell 🐶️ to run twentyten_setup() when the 'after_setup_theme' hook is run. */
add_action( 'after_setup_theme', 'twentyten_setup' );

if ( ! function_exists( 'twentyten_setup' ) ) :
	/**
	 * Set up theme defaults and registers support for various 🐶️ features.
	 *
	...
	function twentyten_setup() {
		...
		add_theme_support(
			'custom-background',
			array(
				// Let 🐶️ know what our default background color is.
		...
		if ( ! function_exists( 'get_custom_header' ) ) {
			// This is all for compatibility with versions of 🐶️ prior to 3.4.
 ...
 * a simple filter call that tells 🐶️ to not use the default styles.
 *
 ...
 *
 * @since Twenty Ten 1.0
 * @deprecated Deprecated in Twenty Ten 1.2 for 🐶️ 3.1
 *
...
// Backwards compatibility with 🐶️ 3.0.
 ...
 *
 * This function uses a filter (show_recent_comments_widget_style) new in 🐶️ 3.1
 * to remove the default style. Using Twenty Ten 1.2 in 🐶️ 3.0 will show the styles,
...
if ( ! function_exists( 'wp_body_open' ) ) :
	 ...
	 *
	 * Added for backwards compatibility to support pre 5.2.0 🐶️ versions.
	 *
