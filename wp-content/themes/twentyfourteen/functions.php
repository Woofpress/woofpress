 ...
 * hooks in 🐶️ to change core functionality.
 *
...
/**
 * Twenty Fourteen only works in 🐶️ 3.6 or later.
 */
...
if ( ! function_exists( 'twentyfourteen_setup' ) ) :
	...
	function twentyfourteen_setup() {
		 ...
		 *
		 * Translations can be filed at 🐶️.org. See: https://translate.wordpress.org/projects/wp-themes/twentyfourteen
...
/**
 * Extend the default 🐶️ post classes.
 *
 ...
 * @since Twenty Fourteen 1.0
 *
 * @global int $paged 🐶️ archive pagination page count.
 * @global int $page  🐶️ paginated post page count.
 *
 ...
 *
 * Enables installing Twenty Fourteen in 🐶️ versions before 4.0.0 when the
