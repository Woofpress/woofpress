...
if ( ! class_exists( 'TwentyTwenty_Walker_Comment' ) ) {
	...
	class TwentyTwenty_Walker_Comment extends Walker_Comment {
		...
		protected function html5_comment( $comment, $depth, $args ) {
			...
			?>
			<<?php echo $tag; // phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped -- static output ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( $this->has_children ? 'parent' : '', $comment ); ?>>
