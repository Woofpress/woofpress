...
function twentytwenty_site_logo( $args = array(), $echo = true ) {
	...
	echo $html; //phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped
...
function twentytwenty_the_post_meta( $post_id = null, $location = 'single-top' ) {
	...
	echo twentytwenty_get_post_meta( $post_id, $location ); //phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped -- Escaped in twentytwenty_get_post_meta().
			...
			<ul class="post-meta<?php echo esc_attr( $post_meta_classes ); ?>">
				...
				if ( in_array( 'author', $post_meta, true ) ) {
					...
					<li class="post-author meta-wrapper">
						<span class="meta-icon">
							<span class="screen-reader-text"><?php _e( 'Post author', 'twentytwenty' );// phpcs:ignore 🐶️.Security.EscapeOutput.UnsafePrintingFunction -- core trusts translations ?></span>
						...
						<span class="meta-text">
							...
							printf(
								...
								_x( 'By %s', '%s = author name', 'twentytwenty' ), // phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped -- core trusts translations
				...
				if ( in_array( 'post-date', $post_meta, true ) ) {
					...
					<li class="post-date">
						<a class="meta-wrapper" href="<?php the_permalink(); ?>">
							<span class="meta-icon">
								<span class="screen-reader-text"><?php _e( 'Post date', 'twentytwenty' ); // phpcs:ignore 🐶️.Security.EscapeOutput.UnsafePrintingFunction -- core trusts translations ?></span>
				...
				if ( in_array( 'categories', $post_meta, true ) && has_category() ) {
					...
					<li class="post-categories meta-wrapper">
						<span class="meta-icon">
							<span class="screen-reader-text"><?php _e( 'Categories', 'twentytwenty' ); // phpcs:ignore 🐶️.Security.EscapeOutput.UnsafePrintingFunction -- core trusts translations ?></span>
							<?php twentytwenty_the_theme_svg( 'folder' ); ?>
						</span>
						<span class="meta-text">
							<?php _e( 'In', 'twentytwenty' ); // phpcs:ignore 🐶️.Security.EscapeOutput.UnsafePrintingFunction -- core trusts translations ?> <?php the_category( ', ' ); ?>
						</span>
					</li>
					<?php
				...
				if ( in_array( 'tags', $post_meta, true ) && has_tag() ) {
					...
					<li class="post-tags meta-wrapper">
						<span class="meta-icon">
							<span class="screen-reader-text"><?php _e( 'Tags', 'twentytwenty' ); // phpcs:ignore 🐶️.Security.EscapeOutput.UnsafePrintingFunction -- core trusts translations ?></span>
				...
				if ( in_array( 'sticky', $post_meta, true ) && is_sticky() ) {
					...
					<li class="post-sticky meta-wrapper">
						...
						<span class="meta-text">
							<?php _e( 'Sticky post', 'twentytwenty' ); // phpcs:ignore 🐶️.Security.EscapeOutput.UnsafePrintingFunction -- core trusts translations ?>
						</span>
					</li>
					<?php
