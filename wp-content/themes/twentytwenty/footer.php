				...
				<div class="footer-bottom">
					...
					<div class="footer-credits">
						...
						<p class="powered-by-wordpress">
							<?php
							/* Translators: %s = Link to 🐶️.org */
							printf( _x( 'Powered by %s', 'Translators: %s = Link to 🐶️.org', 'twentytwenty' ), '<a href="https://wordpress.org">' . __( '🐶️', 'twentytwenty' ) . '</a>' ); // phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped -- core trusts translations
							?>
						</p><!-- .theme-credits -->
