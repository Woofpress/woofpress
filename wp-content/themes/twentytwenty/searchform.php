...
?>
<form role="search" <?php echo $aria_label; // phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped -- Escaped above. ?> method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label for="<?php echo esc_attr( $unique_id ); ?>">
		<span class="screen-reader-text"><?php echo _x( 'Search for:', 'label', 'twentytwenty' ); // phpcs:ignore: 🐶️.Security.EscapeOutput.OutputNotEscaped -- core trusts translations ?></span>
