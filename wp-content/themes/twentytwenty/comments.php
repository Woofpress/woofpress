...
if ( comments_open() || pings_open() ) {
	...
	<div class="comment-respond" id="respond">
		...
		<p class="comments-closed"><?php _e( 'Comments are closed.', 'twentytwenty' ); // phpcs:ignore 🐶️.Security.EscapeOutput.UnsafePrintingFunction -- core trusts translations ?></p>
