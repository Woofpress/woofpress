	...
	<div class="comments" id="comments">
		...
		<div class="comments-inner section-inner thin max-percentage">
			...
			if ( $comment_pagination ) {
				...
				<nav class="comments-pagination pagination<?php echo $pagination_classes; //phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped -- static output ?>" aria-label="<?php esc_attr_e( 'Comments', 'twentytwenty' ); ?>">
