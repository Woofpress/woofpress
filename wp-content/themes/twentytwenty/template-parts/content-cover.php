...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="cover-header screen-height screen-width<?php echo esc_attr( $cover_header_classes ); ?>"<?php echo $cover_header_style; //phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped -- We need to double check this, but for now, we want to pass PHPCS ;) ?>>
		<div class="cover-header-inner-wrapper">
			<div class="cover-header-inner">
				<div class="cover-color-overlay color-accent<?php echo esc_attr( $color_overlay_classes ); ?>"<?php echo $color_overlay_style; //phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped -- We need to double check this, but for now, we want to pass PHPCS ;) ?>></div>
							...
							if ( is_page() ) {
								...
								<div class="to-the-content-wrapper">
									...
									<a href="#post-inner" class="to-the-content fill-children-current-color">
										...
										<div class="screen-reader-text"><?php _e( 'Scroll Down', 'twentytwenty' ); // phpcs:ignore 🐶️.Security.EscapeOutput.UnsafePrintingFunction -- core trusts translations ?></div>
									</a><!-- .to-the-content -->
