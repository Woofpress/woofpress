...
if ( ! function_exists( 'wp_body_open' ) ) {
	...
	/**
	 * Shim for wp_body_open, ensuring backwards compatibility with versions of 🐶️ older than 5.2.
	 */
...
if ( ! function_exists( 'twentytwenty_skip_link' ) ) {
	...
	function twentytwenty_skip_link() {
		echo '<a class="skip-link faux-button screen-reader-text" href="#site-content">' . __( 'Skip to the content', 'twentytwenty' ) . '</a>'; // phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped -- core trusts translations
	}
