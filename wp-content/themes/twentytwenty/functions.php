...
function twentytwenty_skip_link() {
	echo '<a class="skip-link screen-reader-text" href="#site-content">' . __( 'Skip to the content', 'twentytwenty' ) . '</a>'; // phpcs:ignore 🐶️.Security.EscapeOutput.OutputNotEscaped -- core trusts translations
}
